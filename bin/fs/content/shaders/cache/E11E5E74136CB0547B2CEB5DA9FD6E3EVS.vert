...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        bool _91 = floatBitsToInt(RVar[0u].x) == (0);
        predVar = _91;
        stateVar = _91 ? 0 : 1;
    }
    if (stateVar == 0)
    {
        ...
        RVar[19u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[4u].w), CBUFFER_1.values[0]);
        RVar[127u].x = _118 * CBUFFER_1.values[0].z;
        RVar[19u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[4u].w), CBUFFER_1.values[1]);
        RVar[19u].z = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[4u].w), CBUFFER_1.values[2]);
    ...
    if (stateVar == 0)
    {
        ...
        bool _239 = floatBitsToInt(RVar[0u].y) == (0);
        predVar = _239;
        stateVar = _239 ? 0 : 1;
    }
    if (stateVar == 0)
    ...
    if (stateVar == 0)
    {
        ...
        RVar[19u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[4u].w), RVar[0u]);
        RVar[127u].x = _306 * _308;
        RVar[19u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[4u].w), RVar[2u]);
        RVar[19u].z = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[4u].w), RVar[1u]);
    ...
    if (stateVar == 0)
    {
        ...
        bool _425 = floatBitsToInt(RVar[0u].y) == (0);
        predVar = _425;
        stateVar = _425 ? 0 : 1;
    }
    if (stateVar == 0)
    ...
    if (stateVar == 0)
    {
        ...
        RVar[127u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[4u].w), RVar[9u]);
    ...
    if (stateVar == 0)
    {
        ...
        bool _849 = floatBitsToInt(RVar[0u].x) == (0);
        predVar = _849;
        stateVar = _849 ? 0 : 1;
    }
    if (stateVar == 0)
    ...
    if (stateVar == 0)
    {
        ...
        RVar[1u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[4u].w), RVar[9u]);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[127u].z = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[4u].w), RVar[14u]);
    ...
    if (stateVar == 0)
    {
        ...
        bool _1442 = floatBitsToInt(RVar[0u].y) == (0);
        predVar = _1442;
        stateVar = _1442 ? 0 : 1;
    }
    if (stateVar == 0)
    ...
    if (stateVar == 0)
    {
        ...
        RVar[0u].w = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[4u].w), RVar[9u]);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[127u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[4u].w), RVar[13u]);
        RVar[0u].y = (_1690 * dot(vec4(_1669, _1671, _1673, _1675), _1678)) + uintBitsToFloat(0u);
        float _1738 = RVar[4u].z;
        float _1740 = RVar[12u].z;
        RVar[126u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[4u].w), RVar[12u]);
        RVar[125u].x = _1738 * _1740;
        float _1757 = RVar[4u].z;
        float _1759 = RVar[7u].z;
        RVar[125u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[4u].w), RVar[7u]);
    ...
    do
    {
        ...
        if (stateVar == 0)
        {
            RVar[0u].y = intBitsToFloat((floatBitsToInt(CBUFFER_1.values[3].x) > floatBitsToInt(RVar[9u].x)) ? (-1) : 0);
            bool _2284 = floatBitsToInt(RVar[0u].y) != (0);
            predVar = _2284;
            stateVar = _2284 ? 0 : 1;
        }
        if (stateVar == 1)
    ...
    if (stateVar == 0)
    {
        ...
        RVar[2u].y = _2791;
        RVar[5u].x = (_2784 * uintBitsToFloat(1056964608u)) + uintBitsToFloat(1056964608u);
        ...
        float _2831 = RVar[2u].z;
        float _2848 = RVar[127u].z;
        ...
        RVar[126u].x = (_2866 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[127u].y = (_2866 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        RVar[127u].z = (_2866 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        RVar[126u].y = (_2866 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2896 = RVar[2u].x;
        float _2898 = RVar[2u].y;
        float _2900 = RVar[2u].z;
        float _2914 = min(max(-dot(vec4(_2852, _2854, _2831 * CBUFFER_3.values[8].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[8].x, CBUFFER_3.values[8].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2928 = RVar[127u].y;
        float _2934 = RVar[127u].z;
        float _2940 = RVar[126u].y;
        RVar[127u].y = (_2914 * CBUFFER_3.values[16].x) + RVar[126u].x;
        RVar[127u].z = (_2914 * CBUFFER_3.values[16].y) + _2928;
        RVar[127u].w = (_2914 * CBUFFER_3.values[16].z) + _2934;
        RVar[126u].z = (_2914 * CBUFFER_3.values[16].w) + _2940;
        ...
        float _2980 = RVar[127u].y;
        float _2986 = RVar[127u].w;
        float _2992 = RVar[126u].z;
        RVar[126u].x = (_2966 * CBUFFER_3.values[17].y) + RVar[127u].z;
        RVar[127u].z = (_2966 * CBUFFER_3.values[17].x) + _2980;
        RVar[127u].w = (_2966 * CBUFFER_3.values[17].z) + _2986;
        RVar[126u].w = (_2966 * CBUFFER_3.values[17].w) + _2992;
        ...
        float _3029 = RVar[127u].w;
        float _3038 = RVar[127u].z;
        float _3044 = RVar[126u].w;
        RVar[126u].x = (_3018 * CBUFFER_3.values[18].y) + RVar[126u].x;
        RVar[127u].y = (_3018 * CBUFFER_3.values[18].z) + _3029;
        RVar[127u].w = (_3018 * CBUFFER_3.values[18].x) + _3038;
        RVar[127u].x = (_3018 * CBUFFER_3.values[18].w) + _3044;
        ...
        float _3081 = RVar[126u].x;
        float _3087 = RVar[127u].y;
        float _3096 = RVar[127u].x;
        RVar[127u].x = (_3070 * CBUFFER_3.values[19].x) + RVar[127u].w;
        RVar[127u].y = (_3070 * CBUFFER_3.values[19].y) + _3081;
        RVar[127u].z = (_3070 * CBUFFER_3.values[19].z) + _3087;
        RVar[126u].y = (_3070 * CBUFFER_3.values[19].w) + _3096;
        ...
        float _3130 = RVar[127u].x;
        float _3136 = RVar[127u].y;
        float _3142 = RVar[127u].z;
        float _3148 = RVar[126u].y;
        ...
        RVar[4u].y = (_3122 * CBUFFER_3.values[20].x) + _3130;
        RVar[4u].z = (_3122 * CBUFFER_3.values[20].y) + _3136;
        RVar[2u].w = (_3122 * CBUFFER_3.values[20].z) + _3142;
        RVar[5u].z = (_3122 * CBUFFER_3.values[20].w) + _3148;
    }
    ...
    if (stateVar == 0)
    {
        ...
        float _3214 = RVar[4u].x;
        float _3216 = min(_3214, uintBitsToFloat(1065353216u));
        float _3230 = RVar[4u].y;
        float _3236 = RVar[2u].w;
        float _3242 = RVar[5u].z;
        RVar[127u].x = (_3216 * CBUFFER_3.values[21].y) + RVar[4u].z;
        RVar[127u].z = (_3216 * CBUFFER_3.values[21].x) + _3230;
        RVar[127u].w = (_3216 * CBUFFER_3.values[21].z) + _3236;
        RVar[126u].w = (_3216 * CBUFFER_3.values[21].w) + _3242;
        float _3250 = min(max(-dot(vec4(_3196, _3198, _3200, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[14].x, CBUFFER_3.values[14].y, CBUFFER_3.values[14].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3260 = RVar[6u].z;
        RVar[126u].y = RVar[6u].z * CBUFFER_4.values[20].w;
        RVar[126u].x = _3260 * CBUFFER_4.values[17].w;
        float _3277 = RVar[127u].w;
        float _3284 = RVar[127u].x;
        float _3287 = clamp((_3250 * CBUFFER_3.values[22].y) + _3284, 0.0, 1.0);
        float _3291 = RVar[127u].z;
        float _3294 = clamp((_3250 * CBUFFER_3.values[22].x) + _3291, 0.0, 1.0);
        RVar[127u].x = clamp((_3250 * CBUFFER_3.values[22].w) + RVar[126u].w, 0.0, 1.0);
        RVar[127u].y = clamp((_3250 * CBUFFER_3.values[22].z) + _3277, 0.0, 1.0);
        RVar[123u].z = _3287;
        RVar[123u].w = _3294;
        float _3306 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3287, 0.0, 1.0);
        float _3313 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3294, 0.0, 1.0);
        RVar[123u].z = _3306;
        RVar[123u].w = _3313;
        float _3323 = RVar[127u].y;
        float _3326 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3323, 0.0, 1.0);
        float _3330 = RVar[127u].x;
        RVar[123u].y = _3326;
        float _3340 = RVar[3u].y;
        float _3347 = RVar[6u].z;
        ...
        float _3370 = RVar[6u].z;
        float _3374 = RVar[126u].y;
        float _3376 = (_3370 * CBUFFER_4.values[20].z) + _3374;
        RVar[123u].x = _3362;
        RVar[2u].z = _3364 * max(_3326, uintBitsToFloat(1065353216u));
        RVar[2u].w = _3367 * max(clamp(_3330 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        RVar[122u].x = _3376;
        float _3388 = RVar[5u].y;
        RVar[0u].x = (RVar[5u].x * CBUFFER_4.values[17].x) + _3362;
        RVar[126u].x = (_3388 * CBUFFER_4.values[20].y) + _3376;
        RVar[0u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[18]);
        float _3417 = RVar[6u].z;
        RVar[1u].x = (RVar[5u].x * CBUFFER_4.values[20].x) + RVar[126u].x;
        RVar[1u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[6u].z, _3417 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
        RVar[3u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[23]);
        RVar[3u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[24]);
    }
    PARAM_2 = RVar[2u];
