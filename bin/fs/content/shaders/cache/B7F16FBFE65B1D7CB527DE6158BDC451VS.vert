...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[7u].x = uintBitsToFloat(1065353216u);
        RVar[0u].w = dot(RVar[20u], CBUFFER_3.values[6]);
        RVar[7u].w = uintBitsToFloat(0u);
        vec4 _2723 = RVar[21u];
        vec4 _2725 = RVar[21u];
        float _2753 = inversesqrt(dot(_2723, _2725));
        RVar[8u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, RVar[5u].z * CBUFFER_4.values[17].w), vec4(CBUFFER_4.values[17].x, CBUFFER_4.values[17].y, CBUFFER_4.values[17].z, uintBitsToFloat(1065353216u)));
        ...
        RVar[127u].z = _2763;
        RVar[127u].w = _2766;
        RVar[4u].x = _2768 * CBUFFER_4.values[18].w;
        ...
        RVar[1u].y = _2788;
        RVar[5u].x = (_2781 * uintBitsToFloat(1056964608u)) + uintBitsToFloat(1056964608u);
        ...
        float _2828 = RVar[1u].z;
        float _2839 = RVar[1u].z;
        RVar[9u].z = RVar[127u].z;
        RVar[127u].x = _2839 * CBUFFER_3.values[9].z;
        ...
        float _2868 = RVar[127u].x;
        float _2870 = (_2864 * CBUFFER_3.values[9].y) + _2868;
        RVar[123u].x = _2870;
        RVar[126u].z = (_2861 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[127u].w = (_2861 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        float _2889 = RVar[127u].z;
        float _2894 = (_2889 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2896 = min(max(-dot(vec4(_2847, _2849, _2828 * CBUFFER_3.values[8].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[8].x, CBUFFER_3.values[8].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2898 = RVar[1u].x;
        float _2902 = (_2898 * CBUFFER_3.values[9].x) + _2870;
        float _2904 = RVar[127u].z;
        float _2909 = (_2904 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        RVar[123u].x = _2894;
        RVar[123u].z = _2902;
        RVar[123u].w = _2909;
        float _2926 = RVar[126u].z;
        RVar[127u].y = (_2896 * CBUFFER_3.values[16].y) + RVar[127u].w;
        RVar[126u].z = (_2896 * CBUFFER_3.values[16].x) + _2926;
        RVar[127u].w = (_2896 * CBUFFER_3.values[16].z) + _2909;
        RVar[126u].w = (_2896 * CBUFFER_3.values[16].w) + _2894;
        float _2942 = RVar[1u].x;
        float _2944 = RVar[1u].y;
        float _2946 = RVar[1u].z;
        float _2960 = min(max(-_2902, uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2970 = RVar[127u].w;
        float _2979 = RVar[126u].z;
        float _2985 = RVar[126u].w;
        RVar[127u].x = (_2960 * CBUFFER_3.values[17].y) + RVar[127u].y;
        RVar[127u].y = (_2960 * CBUFFER_3.values[17].z) + _2970;
        RVar[127u].w = (_2960 * CBUFFER_3.values[17].x) + _2979;
        ...
        float _3021 = RVar[127u].w;
        float _3027 = RVar[127u].y;
        float _3036 = RVar[126u].y;
        RVar[127u].x = (_3011 * CBUFFER_3.values[18].y) + RVar[127u].x;
        RVar[127u].y = (_3011 * CBUFFER_3.values[18].x) + _3021;
        RVar[126u].z = (_3011 * CBUFFER_3.values[18].z) + _3027;
        RVar[126u].x = (_3011 * CBUFFER_3.values[18].w) + _3036;
        ...
        float _3076 = RVar[127u].x;
        float _3082 = RVar[126u].z;
        float _3088 = RVar[126u].x;
        RVar[127u].x = (_3062 * CBUFFER_3.values[19].x) + RVar[127u].y;
        RVar[126u].z = (_3062 * CBUFFER_3.values[19].y) + _3076;
        RVar[127u].w = (_3062 * CBUFFER_3.values[19].z) + _3082;
        RVar[127u].z = (_3062 * CBUFFER_3.values[19].w) + _3088;
        ...
        float _3122 = RVar[126u].z;
        float _3128 = RVar[127u].x;
        float _3134 = RVar[127u].w;
        float _3140 = RVar[127u].z;
        ...
        RVar[2u].y = (_3114 * CBUFFER_3.values[20].y) + _3122;
        RVar[2u].z = (_3114 * CBUFFER_3.values[20].x) + _3128;
        RVar[1u].w = (_3114 * CBUFFER_3.values[20].z) + _3134;
        RVar[2u].w = (_3114 * CBUFFER_3.values[20].w) + _3140;
    }
    ...
    gl_Position = _3175;
    PARAM_0 = RVar[9u];
    PARAM_1 = vec4(RVar[7u].x, RVar[7u].x, RVar[7u].x, RVar[7u].w);
    if (stateVar == 0)
    {
        float _3190 = RVar[1u].x;
        float _3192 = RVar[1u].y;
        float _3194 = RVar[1u].z;
        float _3208 = RVar[2u].x;
        float _3210 = min(_3208, uintBitsToFloat(1065353216u));
        float _3221 = RVar[1u].w;
        float _3230 = RVar[2u].z;
        float _3236 = RVar[2u].w;
        RVar[127u].x = (_3210 * CBUFFER_3.values[21].y) + RVar[2u].y;
        RVar[127u].y = (_3210 * CBUFFER_3.values[21].z) + _3221;
        RVar[127u].w = (_3210 * CBUFFER_3.values[21].x) + _3230;
        RVar[126u].y = (_3210 * CBUFFER_3.values[21].w) + _3236;
        float _3244 = min(max(-dot(vec4(_3190, _3192, _3194, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[14].x, CBUFFER_3.values[14].y, CBUFFER_3.values[14].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3251 = RVar[5u].z;
        float _3255 = RVar[4u].x;
        RVar[125u].y = RVar[4u].z * CBUFFER_4.values[20].w;
        RVar[126u].x = (_3251 * CBUFFER_4.values[18].z) + _3255;
        float _3271 = RVar[127u].w;
        float _3274 = clamp((_3244 * CBUFFER_3.values[22].x) + _3271, 0.0, 1.0);
        float _3278 = RVar[127u].y;
        float _3285 = RVar[127u].x;
        float _3288 = clamp((_3244 * CBUFFER_3.values[22].y) + _3285, 0.0, 1.0);
        RVar[127u].x = clamp((_3244 * CBUFFER_3.values[22].w) + RVar[126u].y, 0.0, 1.0);
        RVar[123u].y = _3274;
        RVar[127u].z = clamp((_3244 * CBUFFER_3.values[22].z) + _3278, 0.0, 1.0);
        RVar[123u].w = _3288;
        float _3300 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3274, 0.0, 1.0);
        float _3307 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3288, 0.0, 1.0);
        RVar[123u].y = _3300;
        RVar[123u].w = _3307;
        float _3311 = RVar[127u].x;
        float _3323 = RVar[127u].z;
        float _3326 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3323, 0.0, 1.0);
        RVar[123u].z = _3326;
        ...
        RVar[123u].x = _3337;
        RVar[1u].y = _3339 * max(_3307, uintBitsToFloat(1065353216u));
        RVar[1u].x = _3346 * max(_3300, uintBitsToFloat(1065353216u));
        float _3352 = RVar[4u].z;
        float _3356 = RVar[125u].y;
        float _3358 = (_3352 * CBUFFER_4.values[20].z) + _3356;
        float _3360 = RVar[6u].x;
        float _3366 = RVar[3u].z;
        float _3369 = RVar[3u].w;
        RVar[123u].x = _3358;
        RVar[8u].y = (_3360 * CBUFFER_4.values[18].x) + _3337;
        RVar[1u].z = _3366 * max(_3326, uintBitsToFloat(1065353216u));
        RVar[1u].w = _3369 * max(clamp(_3311 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        float _3390 = RVar[4u].z;
        RVar[0u].x = dot(vec4(RVar[5u].x, RVar[4u].y, _3358, uintBitsToFloat(0u)), vec4(CBUFFER_4.values[20].x, CBUFFER_4.values[20].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[0u].y = dot(vec4(RVar[5u].x, RVar[4u].y, RVar[4u].z, _3390 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
    }
    PARAM_2 = RVar[1u];
    PARAM_3 = vec4(RVar[8u].x, RVar[8u].y, RVar[8u].z, RVar[8u].z);
