...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        float _2870 = RVar[127u].x;
        float _2872 = (_2866 * CBUFFER_3.values[9].y) + _2870;
        RVar[123u].x = _2872;
        RVar[127u].y = (_2863 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[126u].z = (_2863 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        float _2891 = RVar[127u].z;
        float _2896 = (_2891 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2898 = RVar[127u].z;
        float _2903 = (_2898 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        float _2905 = RVar[1u].x;
        float _2909 = (_2905 * CBUFFER_3.values[9].x) + _2872;
        ...
        RVar[127u].y = (_2911 * CBUFFER_3.values[16].y) + RVar[126u].z;
        RVar[126u].z = (_2911 * CBUFFER_3.values[16].x) + _2928;
        RVar[127u].w = (_2911 * CBUFFER_3.values[16].z) + _2903;
        RVar[126u].y = (_2911 * CBUFFER_3.values[16].w) + _2896;
        float _2944 = RVar[1u].x;
        float _2946 = RVar[1u].y;
        float _2948 = RVar[1u].z;
        float _2962 = min(max(-_2909, uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2972 = RVar[126u].z;
        float _2981 = RVar[127u].w;
        float _2987 = RVar[126u].y;
        RVar[127u].x = (_2962 * CBUFFER_3.values[17].y) + RVar[127u].y;
        RVar[127u].y = (_2962 * CBUFFER_3.values[17].x) + _2972;
        RVar[127u].w = (_2962 * CBUFFER_3.values[17].z) + _2981;
        RVar[126u].w = (_2962 * CBUFFER_3.values[17].w) + _2987;
        ...
        float _3026 = RVar[127u].w;
        float _3032 = RVar[127u].y;
        float _3038 = RVar[126u].w;
        RVar[127u].x = (_3013 * CBUFFER_3.values[18].y) + RVar[127u].x;
        RVar[126u].z = (_3013 * CBUFFER_3.values[18].z) + _3026;
        RVar[127u].w = (_3013 * CBUFFER_3.values[18].x) + _3032;
        RVar[126u].x = (_3013 * CBUFFER_3.values[18].w) + _3038;
        ...
        float _3075 = RVar[127u].x;
        float _3081 = RVar[126u].z;
        float _3090 = RVar[126u].x;
        RVar[127u].x = (_3064 * CBUFFER_3.values[19].x) + RVar[127u].w;
        RVar[127u].y = (_3064 * CBUFFER_3.values[19].y) + _3075;
        RVar[126u].z = (_3064 * CBUFFER_3.values[19].z) + _3081;
        RVar[127u].z = (_3064 * CBUFFER_3.values[19].w) + _3090;
        ...
        RVar[2u].y = (_3116 * CBUFFER_3.values[20].y) + _3124;
        RVar[2u].z = (_3116 * CBUFFER_3.values[20].x) + _3130;
        RVar[1u].w = (_3116 * CBUFFER_3.values[20].z) + _3136;
        RVar[4u].y = (_3116 * CBUFFER_3.values[20].w) + _3142;
    }
    ...
    if (stateVar == 0)
    {
        ...
        float _3210 = RVar[2u].x;
        float _3212 = min(_3210, uintBitsToFloat(1065353216u));
        float _3223 = RVar[2u].z;
        float _3232 = RVar[1u].w;
        float _3238 = RVar[4u].y;
        RVar[127u].x = (_3212 * CBUFFER_3.values[21].y) + RVar[2u].y;
        RVar[127u].y = (_3212 * CBUFFER_3.values[21].x) + _3223;
        RVar[127u].w = (_3212 * CBUFFER_3.values[21].z) + _3232;
        RVar[126u].w = (_3212 * CBUFFER_3.values[21].w) + _3238;
        float _3246 = min(max(-dot(vec4(_3192, _3194, _3196, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[14].x, CBUFFER_3.values[14].y, CBUFFER_3.values[14].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3253 = RVar[5u].z;
        float _3257 = RVar[4u].x;
        RVar[126u].y = RVar[5u].z * CBUFFER_4.values[20].w;
        RVar[126u].x = (_3253 * CBUFFER_4.values[18].z) + _3257;
        float _3273 = RVar[127u].x;
        float _3276 = clamp((_3246 * CBUFFER_3.values[22].y) + _3273, 0.0, 1.0);
        float _3280 = RVar[127u].w;
        float _3287 = RVar[127u].y;
        float _3290 = clamp((_3246 * CBUFFER_3.values[22].x) + _3287, 0.0, 1.0);
        RVar[127u].x = clamp((_3246 * CBUFFER_3.values[22].w) + RVar[126u].w, 0.0, 1.0);
        RVar[123u].y = _3276;
        RVar[127u].z = clamp((_3246 * CBUFFER_3.values[22].z) + _3280, 0.0, 1.0);
        RVar[123u].w = _3290;
        float _3302 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3276, 0.0, 1.0);
        float _3309 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3290, 0.0, 1.0);
        RVar[123u].y = _3302;
        RVar[123u].w = _3309;
        float _3313 = RVar[127u].x;
        float _3325 = RVar[127u].z;
        ...
        RVar[4u].x = RVar[3u].x * max(_3309, uintBitsToFloat(1065353216u));
        RVar[4u].y = _3336 * max(_3302, uintBitsToFloat(1065353216u));
        RVar[122u].x = _3349;
        float _3354 = RVar[5u].z;
        float _3358 = RVar[126u].y;
        float _3360 = (_3354 * CBUFFER_4.values[20].z) + _3358;
        float _3362 = RVar[6u].x;
        float _3368 = RVar[3u].z;
        float _3371 = RVar[3u].w;
        RVar[123u].x = _3360;
        RVar[7u].y = (_3362 * CBUFFER_4.values[18].x) + _3349;
        RVar[4u].z = _3368 * max(_3328, uintBitsToFloat(1065353216u));
        RVar[4u].w = _3371 * max(clamp(_3313 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        float _3392 = RVar[5u].z;
        ...
        RVar[0u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, _3392 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
    }
    PARAM_2 = RVar[4u];
