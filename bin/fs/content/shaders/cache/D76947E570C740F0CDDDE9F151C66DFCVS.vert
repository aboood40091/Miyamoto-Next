...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[0u].x = dot(vec4(RVar[8u].x, RVar[2u].y, _3364, uintBitsToFloat(0u)), vec4(CBUFFER_4.values[17].x, CBUFFER_4.values[17].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[0u].y = dot(vec4(RVar[8u].x, RVar[2u].y, RVar[6u].z, _3389 * CBUFFER_4.values[18].w), vec4(CBUFFER_4.values[18].x, CBUFFER_4.values[18].y, CBUFFER_4.values[18].z, uintBitsToFloat(1065353216u)));
        RVar[2u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[8u].z, RVar[8u].z), CBUFFER_4.values[23]);
        RVar[2u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[8u].z, RVar[8u].z), CBUFFER_4.values[24]);
    }
    PARAM_2 = RVar[1u];
