...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[6u].x = CBUFFER_3.values[25].x;
        vec4 _2748 = RVar[19u];
        ...
        RVar[127u].z = _2762;
        RVar[127u].w = _2765;
        RVar[2u].x = (-dot(_2748, CBUFFER_3.values[2])) + (-CBUFFER_3.values[33].x);
        ...
        RVar[6u].y = CBUFFER_3.values[25].y;
        RVar[6u].z = CBUFFER_3.values[25].z;
        RVar[8u].z = _2834;
    ...
    if (stateVar == 0)
    {
        ...
        RVar[6u].w = clamp(RVar[2u].x * CBUFFER_3.values[41].x, 0.0, 1.0);
