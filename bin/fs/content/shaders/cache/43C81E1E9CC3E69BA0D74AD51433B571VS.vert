...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        float _2710 = RVar[20u].w;
        float _2712 = RVar[20u].w;
        RVar[0u].z = dot(RVar[19u], CBUFFER_3.values[5]);
        float _2722 = RVar[20u].z;
        float _2724 = RVar[20u].z;
        float _2726 = (_2722 * _2724) + (_2710 * _2712);
        RVar[0u].w = dot(RVar[19u], CBUFFER_3.values[6]);
        RVar[122u].x = _2726;
        float _2730 = RVar[20u].x;
        float _2732 = RVar[20u].y;
        float _2736 = RVar[20u].x;
        float _2738 = RVar[20u].y;
        RVar[6u].x = CBUFFER_3.values[26].x;
        vec4 _2748 = RVar[19u];
        ...
        float _2755 = RVar[20u].x;
        float _2756 = _2755 * _2753;
        float _2758 = RVar[20u].y;
        float _2759 = _2758 * _2753;
        float _2761 = RVar[20u].z;
        float _2762 = _2761 * _2753;
        float _2764 = RVar[20u].w;
        float _2765 = _2764 * _2753;
        RVar[127u].x = _2756;
        RVar[127u].y = _2759;
        RVar[127u].z = _2762;
        RVar[127u].w = _2765;
        RVar[2u].x = (-dot(_2748, CBUFFER_3.values[2])) + (-CBUFFER_3.values[34].x);
        float _2780 = dot(vec4(_2756, _2759, _2762, _2765), CBUFFER_3.values[0]);
        RVar[1u].x = _2780;
        RVar[8u].x = _2756;
        vec4 _2784 = RVar[127u];
        float _2787 = dot(_2784, CBUFFER_3.values[1]);
        RVar[2u].y = _2787;
        RVar[3u].x = (_2780 * uintBitsToFloat(1056964608u)) + uintBitsToFloat(1056964608u);
        vec4 _2796 = RVar[127u];
        float _2799 = dot(_2796, CBUFFER_3.values[2]);
        RVar[4u].z = _2799;
        RVar[3u].y = ((-_2787) * uintBitsToFloat(1056964608u)) + uintBitsToFloat(1056964608u);
        float _2808 = RVar[1u].x;
        float _2810 = RVar[2u].y;
        RVar[8u].y = RVar[127u].y;
        float _2834 = RVar[127u].z;
        RVar[6u].y = CBUFFER_3.values[26].y;
        RVar[6u].z = CBUFFER_3.values[26].z;
        RVar[8u].z = _2834;
        float _2839 = RVar[1u].x;
        float _2841 = RVar[2u].y;
        float _2843 = RVar[4u].z;
        float _2857 = min(max(-dot(vec4(_2808, _2810, _2799, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[7].x, CBUFFER_3.values[7].y, CBUFFER_3.values[7].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        RVar[127u].y = (_2857 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[127u].z = (_2857 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        RVar[127u].w = (_2857 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        RVar[126u].z = (_2857 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2887 = RVar[1u].x;
        float _2889 = RVar[2u].y;
        float _2891 = RVar[4u].z;
        float _2905 = min(max(-dot(vec4(_2839, _2841, _2843, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[8].x, CBUFFER_3.values[8].y, CBUFFER_3.values[8].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2919 = RVar[127u].y;
        float _2925 = RVar[127u].w;
        float _2931 = RVar[126u].z;
        RVar[127u].x = (_2905 * CBUFFER_3.values[16].y) + RVar[127u].z;
        RVar[127u].z = (_2905 * CBUFFER_3.values[16].x) + _2919;
        RVar[127u].w = (_2905 * CBUFFER_3.values[16].z) + _2925;
        RVar[126u].w = (_2905 * CBUFFER_3.values[16].w) + _2931;
        float _2939 = RVar[1u].x;
        float _2941 = RVar[2u].y;
        float _2943 = RVar[4u].z;
        float _2957 = min(max(-dot(vec4(_2887, _2889, _2891, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[9].x, CBUFFER_3.values[9].y, CBUFFER_3.values[9].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2968 = RVar[127u].w;
        float _2977 = RVar[127u].z;
        float _2983 = RVar[126u].w;
        RVar[127u].x = (_2957 * CBUFFER_3.values[17].y) + RVar[127u].x;
        RVar[127u].y = (_2957 * CBUFFER_3.values[17].z) + _2968;
        RVar[127u].w = (_2957 * CBUFFER_3.values[17].x) + _2977;
        RVar[126u].x = (_2957 * CBUFFER_3.values[17].w) + _2983;
        float _2991 = RVar[1u].x;
        float _2993 = RVar[2u].y;
        float _2995 = RVar[4u].z;
        float _3009 = min(max(-dot(vec4(_2939, _2941, _2943, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[10].x, CBUFFER_3.values[10].y, CBUFFER_3.values[10].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3020 = RVar[127u].x;
        float _3026 = RVar[127u].y;
        float _3035 = RVar[126u].x;
        RVar[127u].x = (_3009 * CBUFFER_3.values[18].x) + RVar[127u].w;
        RVar[127u].y = (_3009 * CBUFFER_3.values[18].y) + _3020;
        RVar[127u].z = (_3009 * CBUFFER_3.values[18].z) + _3026;
        RVar[126u].y = (_3009 * CBUFFER_3.values[18].w) + _3035;
        float _3043 = RVar[1u].x;
        float _3045 = RVar[2u].y;
        float _3047 = RVar[4u].z;
        float _3061 = min(max(-dot(vec4(_2991, _2993, _2995, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[11].x, CBUFFER_3.values[11].y, CBUFFER_3.values[11].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3075 = RVar[127u].y;
        float _3081 = RVar[127u].z;
        float _3087 = RVar[126u].y;
        RVar[1u].y = (_3061 * CBUFFER_3.values[19].x) + RVar[127u].x;
        RVar[2u].z = (_3061 * CBUFFER_3.values[19].y) + _3075;
        RVar[1u].w = (_3061 * CBUFFER_3.values[19].z) + _3081;
        RVar[3u].z = (_3061 * CBUFFER_3.values[19].w) + _3087;
        RVar[1u].z = dot(vec4(RVar[1u].x, RVar[2u].y, RVar[4u].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[13].x, CBUFFER_3.values[13].y, CBUFFER_3.values[13].z, uintBitsToFloat(0u)));
        RVar[2u].w = min(max(-dot(vec4(_3043, _3045, _3047, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[12].x, CBUFFER_3.values[12].y, CBUFFER_3.values[12].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
    }
    vec4 _3132 = (RVar[0u] * vec4(VS_PUSH.posMulAdd.xy, 1.0, 1.0)) + vec4(VS_PUSH.posMulAdd.zw, 0.0, 0.0);
    vec4 _3135 = _3132;
    _3135.y = -_3132.y;
    vec4 _3143 = _3135;
    _3143.z = (_3135.z + (_3135.w * VS_PUSH.zSpaceMul.x)) * VS_PUSH.zSpaceMul.y;
    gl_Position = _3143;
    PARAM_0 = RVar[8u];
    if (stateVar == 0)
    {
        float _3162 = RVar[1u].z;
        float _3167 = RVar[2u].w;
        float _3171 = RVar[1u].y;
        float _3175 = RVar[2u].w;
        float _3179 = RVar[1u].w;
        float _3183 = RVar[2u].w;
        float _3187 = RVar[3u].z;
        RVar[127u].x = (RVar[2u].w * CBUFFER_3.values[20].y) + RVar[2u].z;
        RVar[127u].z = (_3167 * CBUFFER_3.values[20].x) + _3171;
        RVar[127u].w = (_3175 * CBUFFER_3.values[20].z) + _3179;
        RVar[126u].w = (_3183 * CBUFFER_3.values[20].w) + _3187;
        float _3195 = RVar[1u].x;
        float _3197 = RVar[2u].y;
        float _3199 = RVar[4u].z;
        float _3213 = min(max(-_3162, uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3224 = RVar[127u].w;
        float _3233 = RVar[127u].z;
        float _3239 = RVar[126u].w;
        RVar[127u].x = (_3213 * CBUFFER_3.values[21].y) + RVar[127u].x;
        RVar[127u].y = (_3213 * CBUFFER_3.values[21].z) + _3224;
        RVar[127u].w = (_3213 * CBUFFER_3.values[21].x) + _3233;
        RVar[126u].x = (_3213 * CBUFFER_3.values[21].w) + _3239;
        float _3247 = min(max(-dot(vec4(_3195, _3197, _3199, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[14].x, CBUFFER_3.values[14].y, CBUFFER_3.values[14].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        RVar[6u].w = clamp(RVar[2u].x * CBUFFER_3.values[42].x, 0.0, 1.0);
        float _3267 = RVar[126u].x;
        float _3274 = RVar[127u].y;
        float _3281 = RVar[127u].x;
        RVar[2u].x = clamp((_3247 * CBUFFER_3.values[22].x) + RVar[127u].w, 0.0, 1.0);
        RVar[2u].y = clamp((_3247 * CBUFFER_3.values[22].w) + _3267, 0.0, 1.0);
        RVar[4u].z = clamp((_3247 * CBUFFER_3.values[22].z) + _3274, 0.0, 1.0);
        RVar[1u].w = clamp((_3247 * CBUFFER_3.values[22].y) + _3281, 0.0, 1.0);
    }
    PARAM_1 = RVar[6u];
    if (stateVar == 0)
    {
        float _3306 = RVar[2u].x;
        float _3309 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3306, 0.0, 1.0);
        float _3315 = RVar[1u].w;
        float _3318 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3315, 0.0, 1.0);
        RVar[123u].x = _3309;
        RVar[123u].w = _3318;
        float _3324 = RVar[2u].y;
        float _3334 = RVar[4u].z;
        float _3337 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3334, 0.0, 1.0);
        RVar[123u].z = _3337;
        float _3347 = RVar[7u].z;
        RVar[2u].y = max(_3318, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].y;
        RVar[2u].x = max(_3309, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].x;
        float _3359 = RVar[7u].z;
        float _3363 = (_3359 * CBUFFER_4.values[17].z) + (_3347 * CBUFFER_4.values[17].w);
        RVar[123u].x = _3363;
        RVar[2u].z = max(_3337, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].z;
        RVar[2u].w = CBUFFER_4.values[0].w * max(clamp(_3324 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        float _3388 = RVar[7u].z;
        RVar[0u].x = dot(vec4(RVar[5u].x, RVar[5u].y, _3363, uintBitsToFloat(0u)), vec4(CBUFFER_4.values[17].x, CBUFFER_4.values[17].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[0u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[7u].z, _3388 * CBUFFER_4.values[18].w), vec4(CBUFFER_4.values[18].x, CBUFFER_4.values[18].y, CBUFFER_4.values[18].z, uintBitsToFloat(1065353216u)));
        RVar[1u].x = dot(vec4(RVar[3u].x, RVar[3u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[20]);
        RVar[1u].y = dot(vec4(RVar[3u].x, RVar[3u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[21]);
        RVar[4u].x = dot(vec4(RVar[3u].x, RVar[3u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[23]);
        RVar[4u].y = dot(vec4(RVar[3u].x, RVar[3u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[24]);
    }
    PARAM_2 = RVar[2u];
    PARAM_3 = vec4(RVar[0u].x, RVar[0u].y, RVar[0u].z, RVar[0u].z);
    PARAM_4 = vec4(RVar[1u].x, RVar[1u].y, RVar[1u].z, RVar[1u].z);
    PARAM_5 = vec4(RVar[4u].x, RVar[4u].y, RVar[4u].z, RVar[4u].z);
    if (stateVar == 0)
    {
    }
}
