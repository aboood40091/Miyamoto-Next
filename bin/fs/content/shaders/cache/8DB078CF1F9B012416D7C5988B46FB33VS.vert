...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[4u].w = max(clamp(_3334 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u)) * CBUFFER_4.values[0].w;
        float _3389 = RVar[5u].z;
        ...
        RVar[0u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, _3389 * CBUFFER_4.values[18].w), vec4(CBUFFER_4.values[18].x, CBUFFER_4.values[18].y, CBUFFER_4.values[18].z, uintBitsToFloat(1065353216u)));
        RVar[1u].x = dot(vec4(RVar[5u].x, RVar[8u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[20]);
        RVar[1u].y = dot(vec4(RVar[5u].x, RVar[8u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[21]);
        ...
        RVar[3u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[26]);
        RVar[3u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[27]);
    }
    PARAM_2 = RVar[4u];
