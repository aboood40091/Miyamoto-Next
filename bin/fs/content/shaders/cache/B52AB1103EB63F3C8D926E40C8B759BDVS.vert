...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[126u].x = (_2854 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[127u].y = (_2854 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        RVar[127u].z = (_2854 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        RVar[126u].y = (_2854 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2884 = RVar[2u].x;
        float _2886 = RVar[2u].y;
        float _2888 = RVar[2u].z;
        float _2902 = min(max(-dot(vec4(_2840, _2842, _2822 * CBUFFER_3.values[8].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[8].x, CBUFFER_3.values[8].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2916 = RVar[127u].y;
        float _2922 = RVar[127u].z;
        float _2928 = RVar[126u].y;
        RVar[127u].y = (_2902 * CBUFFER_3.values[16].x) + RVar[126u].x;
        RVar[127u].z = (_2902 * CBUFFER_3.values[16].y) + _2916;
        RVar[127u].w = (_2902 * CBUFFER_3.values[16].z) + _2922;
        RVar[126u].z = (_2902 * CBUFFER_3.values[16].w) + _2928;
        ...
        float _2968 = RVar[127u].y;
        float _2974 = RVar[127u].w;
        float _2980 = RVar[126u].z;
        RVar[126u].x = (_2954 * CBUFFER_3.values[17].y) + RVar[127u].z;
        RVar[127u].z = (_2954 * CBUFFER_3.values[17].x) + _2968;
        RVar[127u].w = (_2954 * CBUFFER_3.values[17].z) + _2974;
        RVar[126u].w = (_2954 * CBUFFER_3.values[17].w) + _2980;
        ...
        float _3032 = RVar[126u].w;
        RVar[126u].x = (_3006 * CBUFFER_3.values[18].y) + RVar[126u].x;
        RVar[127u].y = (_3006 * CBUFFER_3.values[18].z) + _3017;
        RVar[127u].w = (_3006 * CBUFFER_3.values[18].x) + _3026;
        RVar[127u].x = (_3006 * CBUFFER_3.values[18].w) + _3032;
        ...
        float _3069 = RVar[126u].x;
        float _3075 = RVar[127u].y;
        float _3084 = RVar[127u].x;
        RVar[127u].x = (_3058 * CBUFFER_3.values[19].x) + RVar[127u].w;
        RVar[127u].y = (_3058 * CBUFFER_3.values[19].y) + _3069;
        RVar[127u].z = (_3058 * CBUFFER_3.values[19].z) + _3075;
        RVar[126u].y = (_3058 * CBUFFER_3.values[19].w) + _3084;
        ...
        float _3118 = RVar[127u].x;
        float _3124 = RVar[127u].y;
        float _3130 = RVar[127u].z;
        float _3136 = RVar[126u].y;
        ...
        RVar[3u].y = (_3110 * CBUFFER_3.values[20].x) + _3118;
        RVar[3u].z = (_3110 * CBUFFER_3.values[20].y) + _3124;
        RVar[2u].w = (_3110 * CBUFFER_3.values[20].z) + _3130;
        RVar[4u].z = (_3110 * CBUFFER_3.values[20].w) + _3136;
    }
    ...
    if (stateVar == 0)
    {
        ...
        float _3202 = RVar[3u].x;
        float _3204 = min(_3202, uintBitsToFloat(1065353216u));
        float _3218 = RVar[3u].y;
        float _3224 = RVar[2u].w;
        float _3230 = RVar[4u].z;
        RVar[127u].x = (_3204 * CBUFFER_3.values[21].y) + RVar[3u].z;
        RVar[127u].z = (_3204 * CBUFFER_3.values[21].x) + _3218;
        RVar[127u].w = (_3204 * CBUFFER_3.values[21].z) + _3224;
        RVar[126u].w = (_3204 * CBUFFER_3.values[21].w) + _3230;
        float _3238 = min(max(-dot(vec4(_3184, _3186, _3188, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[14].x, CBUFFER_3.values[14].y, CBUFFER_3.values[14].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3248 = RVar[5u].z;
        RVar[126u].y = RVar[5u].z * CBUFFER_4.values[20].w;
        RVar[126u].x = _3248 * CBUFFER_4.values[17].w;
        float _3265 = RVar[127u].w;
        float _3272 = RVar[127u].x;
        float _3275 = clamp((_3238 * CBUFFER_3.values[22].y) + _3272, 0.0, 1.0);
        float _3279 = RVar[127u].z;
        float _3282 = clamp((_3238 * CBUFFER_3.values[22].x) + _3279, 0.0, 1.0);
        RVar[127u].x = clamp((_3238 * CBUFFER_3.values[22].w) + RVar[126u].w, 0.0, 1.0);
        RVar[127u].y = clamp((_3238 * CBUFFER_3.values[22].z) + _3265, 0.0, 1.0);
        RVar[123u].z = _3275;
        RVar[123u].w = _3282;
        float _3294 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3275, 0.0, 1.0);
        float _3301 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3282, 0.0, 1.0);
        RVar[123u].z = _3294;
        RVar[123u].w = _3301;
        float _3311 = RVar[127u].y;
        float _3314 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3311, 0.0, 1.0);
        float _3318 = RVar[127u].x;
        RVar[123u].y = _3314;
        float _3335 = RVar[5u].z;
        ...
        RVar[123u].x = _3350;
        RVar[2u].z = max(_3314, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].z;
        RVar[2u].w = CBUFFER_4.values[0].w * max(clamp(_3318 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        float _3367 = RVar[5u].z;
        float _3371 = RVar[126u].y;
        RVar[0u].x = (RVar[5u].x * CBUFFER_4.values[17].x) + _3350;
        RVar[126u].x = (_3367 * CBUFFER_4.values[20].z) + _3371;
        RVar[0u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[18]);
        float _3406 = RVar[5u].z;
        RVar[1u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[126u].x, uintBitsToFloat(0u)), vec4(CBUFFER_4.values[20].x, CBUFFER_4.values[20].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[1u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, _3406 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
        RVar[3u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[23]);
        RVar[3u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[24]);
        RVar[4u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[26]);
        RVar[4u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[27]);
    }
    PARAM_2 = RVar[2u];
