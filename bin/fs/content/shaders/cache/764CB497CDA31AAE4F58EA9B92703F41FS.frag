...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[1u].w = clamp((clamp(clamp(_358 + uintBitsToFloat(0u), 0.0, 1.0) + uintBitsToFloat(0u), 0.0, 1.0) + uintBitsToFloat(0u)) * 0.5, 0.0, 1.0);
        float _427 = RVar[6u].z;
        float _430 = (clamp(_398 + _418, 0.0, 1.0) * _427) + uintBitsToFloat(0u);
        float _432 = RVar[6u].y;
        float _435 = (clamp(_405 + _410, 0.0, 1.0) * _432) + uintBitsToFloat(0u);
        float _437 = RVar[6u].x;
        float _440 = (clamp(_388 + _414, 0.0, 1.0) * _437) + uintBitsToFloat(0u);
        RVar[123u].x = _430;
        RVar[123u].y = _435;
        RVar[123u].z = _440;
        float _446 = clamp(_430 + uintBitsToFloat(0u), 0.0, 1.0);
        float _449 = clamp(_435 + uintBitsToFloat(0u), 0.0, 1.0);
        float _452 = clamp(_440 + uintBitsToFloat(0u), 0.0, 1.0);
        RVar[126u].y = _446;
        RVar[127u].z = _449;
        RVar[127u].w = _452;
        float _461 = RVar[0u].z;
        float _465 = RVar[0u].y;
        float _475 = RVar[0u].w;
        float _477 = RVar[127u].z;
        float _481 = RVar[0u].w;
        float _483 = RVar[126u].y;
        RVar[1u].x = ((RVar[0u].x + (-_452)) * RVar[0u].w) + RVar[127u].w;
        RVar[1u].y = ((_465 + (-_449)) * _475) + _477;
        RVar[1u].z = ((_461 + (-_446)) * _481) + _483;
        float _492 = RVar[5u].y;
        float _494 = RVar[5u].z;
        float _496 = RVar[5u].w;
        RVar[3u].x = RVar[5u].x;
        RVar[3u].y = _492;
        RVar[3u].z = _494;
        RVar[3u].w = _496;
        float _504 = RVar[1u].y;
        float _506 = RVar[1u].z;
        float _508 = RVar[1u].w;
        RVar[2u].x = RVar[1u].x;
        RVar[2u].y = _504;
        RVar[2u].z = _506;
        RVar[2u].w = _508;
    ...
    _pixelTmp = RVar[2u];
    uint _584 = PS_PUSH.alphaFunc >> 8u;
    if (_584 == 1u)
    {
        _pixelTmp = vec4(1.0);
    }
    ...
    _pixelTmp_1 = RVar[3u];
    uint _612 = PS_PUSH.alphaFunc >> 8u;
    if (_612 == 1u)
    {
