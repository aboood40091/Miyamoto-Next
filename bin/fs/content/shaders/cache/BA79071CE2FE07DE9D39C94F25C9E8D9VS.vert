...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[0u].x = intBitsToFloat(floatBitsToInt(CBUFFER_4.values[0].z) + (25));
        RVar[0u].y = intBitsToFloat(floatBitsToInt(CBUFFER_4.values[0].z) + (41));
        RVar[0u].w = intBitsToFloat(floatBitsToInt(CBUFFER_4.values[0].z) + (33));
