...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[5u].x = CBUFFER_3.values[26].x;
        vec4 _2749 = RVar[20u];
        ...
        RVar[4u].z = _2763;
        RVar[127u].w = _2766;
        RVar[4u].x = (-dot(_2749, CBUFFER_3.values[2])) + (-CBUFFER_3.values[34].x);
        float _2781 = dot(vec4(_2757, _2760, _2763, _2766), CBUFFER_3.values[0]);
        RVar[1u].x = _2781;
        RVar[8u].x = _2757;
        float _2785 = RVar[127u].x;
        float _2787 = RVar[127u].y;
        float _2789 = RVar[4u].z;
        float _2791 = RVar[127u].w;
        float _2795 = dot(vec4(_2785, _2787, _2789, _2791), CBUFFER_3.values[1]);
        RVar[1u].y = _2795;
        RVar[7u].x = (_2781 * uintBitsToFloat(1056964608u)) + uintBitsToFloat(1056964608u);
        float _2804 = RVar[127u].x;
        float _2806 = RVar[127u].y;
        float _2808 = RVar[4u].z;
        float _2810 = RVar[127u].w;
        float _2814 = dot(vec4(_2804, _2806, _2808, _2810), CBUFFER_3.values[2]);
        RVar[1u].z = _2814;
        RVar[7u].y = ((-_2795) * uintBitsToFloat(1056964608u)) + uintBitsToFloat(1056964608u);
        float _2823 = RVar[1u].x;
        float _2825 = RVar[1u].y;
        RVar[8u].y = RVar[127u].y;
        RVar[5u].z = CBUFFER_3.values[26].z;
        RVar[5u].y = CBUFFER_3.values[26].y;
        float _2851 = RVar[1u].x;
        float _2853 = RVar[1u].y;
        float _2855 = RVar[1u].z;
        float _2869 = min(max(-dot(vec4(_2823, _2825, _2814, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[7].x, CBUFFER_3.values[7].y, CBUFFER_3.values[7].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        RVar[127u].x = (_2869 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        RVar[127u].y = (_2869 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        RVar[127u].w = (_2869 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[126u].x = (_2869 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2899 = RVar[1u].x;
        float _2901 = RVar[1u].y;
        float _2903 = RVar[1u].z;
        float _2917 = min(max(-dot(vec4(_2851, _2853, _2855, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[8].x, CBUFFER_3.values[8].y, CBUFFER_3.values[8].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2928 = RVar[127u].x;
        float _2934 = RVar[127u].y;
        float _2943 = RVar[126u].x;
        RVar[127u].x = (_2917 * CBUFFER_3.values[16].x) + RVar[127u].w;
        RVar[127u].y = (_2917 * CBUFFER_3.values[16].y) + _2928;
        RVar[127u].z = (_2917 * CBUFFER_3.values[16].z) + _2934;
        RVar[126u].y = (_2917 * CBUFFER_3.values[16].w) + _2943;
        float _2951 = RVar[1u].x;
        float _2953 = RVar[1u].y;
        float _2955 = RVar[1u].z;
        float _2969 = min(max(-dot(vec4(_2899, _2901, _2903, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[9].x, CBUFFER_3.values[9].y, CBUFFER_3.values[9].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2983 = RVar[127u].y;
        float _2989 = RVar[127u].z;
        float _2995 = RVar[126u].y;
        RVar[127u].y = (_2969 * CBUFFER_3.values[17].x) + RVar[127u].x;
        RVar[127u].z = (_2969 * CBUFFER_3.values[17].y) + _2983;
        RVar[127u].w = (_2969 * CBUFFER_3.values[17].z) + _2989;
        RVar[126u].z = (_2969 * CBUFFER_3.values[17].w) + _2995;
        float _3003 = RVar[1u].x;
        float _3005 = RVar[1u].y;
        float _3007 = RVar[1u].z;
        float _3021 = min(max(-dot(vec4(_2951, _2953, _2955, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[10].x, CBUFFER_3.values[10].y, CBUFFER_3.values[10].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3035 = RVar[127u].y;
        float _3041 = RVar[127u].w;
        float _3047 = RVar[126u].z;
        RVar[127u].x = (_3021 * CBUFFER_3.values[18].y) + RVar[127u].z;
        RVar[127u].z = (_3021 * CBUFFER_3.values[18].x) + _3035;
        RVar[127u].w = (_3021 * CBUFFER_3.values[18].z) + _3041;
        RVar[126u].w = (_3021 * CBUFFER_3.values[18].w) + _3047;
        float _3055 = RVar[1u].x;
        float _3057 = RVar[1u].y;
        float _3059 = RVar[1u].z;
        float _3073 = min(max(-dot(vec4(_3003, _3005, _3007, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[11].x, CBUFFER_3.values[11].y, CBUFFER_3.values[11].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3084 = RVar[127u].w;
        float _3093 = RVar[127u].z;
        float _3099 = RVar[126u].w;
        RVar[127u].x = (_3073 * CBUFFER_3.values[19].y) + RVar[127u].x;
        RVar[127u].y = (_3073 * CBUFFER_3.values[19].z) + _3084;
        RVar[127u].w = (_3073 * CBUFFER_3.values[19].x) + _3093;
        RVar[126u].x = (_3073 * CBUFFER_3.values[19].w) + _3099;
        float _3107 = RVar[1u].x;
        float _3109 = RVar[1u].y;
        float _3111 = RVar[1u].z;
        float _3125 = min(max(-dot(vec4(_3055, _3057, _3059, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[12].x, CBUFFER_3.values[12].y, CBUFFER_3.values[12].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3136 = RVar[127u].x;
        float _3142 = RVar[127u].y;
        float _3151 = RVar[126u].x;
        RVar[2u].x = (_3125 * CBUFFER_3.values[20].x) + RVar[127u].w;
        RVar[2u].y = (_3125 * CBUFFER_3.values[20].y) + _3136;
        RVar[2u].z = (_3125 * CBUFFER_3.values[20].z) + _3142;
        RVar[1u].w = max(-dot(vec4(_3107, _3109, _3111, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[13].x, CBUFFER_3.values[13].y, CBUFFER_3.values[13].z, uintBitsToFloat(0u))), uintBitsToFloat(0u));
        RVar[4u].y = (_3125 * CBUFFER_3.values[20].w) + _3151;
    }
    vec4 _3175 = (RVar[0u] * vec4(VS_PUSH.posMulAdd.xy, 1.0, 1.0)) + vec4(VS_PUSH.posMulAdd.zw, 0.0, 0.0);
    vec4 _3178 = _3175;
    _3178.y = -_3175.y;
    vec4 _3186 = _3178;
    _3186.z = (_3178.z + (_3178.w * VS_PUSH.zSpaceMul.x)) * VS_PUSH.zSpaceMul.y;
    gl_Position = _3186;
    if (stateVar == 0)
    {
        ...
        float _3238 = RVar[4u].y;
        RVar[127u].y = (_3212 * CBUFFER_3.values[21].x) + RVar[2u].x;
        RVar[127u].z = (_3212 * CBUFFER_3.values[21].y) + _3226;
        RVar[127u].w = (_3212 * CBUFFER_3.values[21].z) + _3232;
        RVar[126u].z = (_3212 * CBUFFER_3.values[21].w) + _3238;
        float _3248 = min(max(-dot(vec4(_3192, _3194, _3196, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[14].x, CBUFFER_3.values[14].y, CBUFFER_3.values[14].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3250 = RVar[4u].x;
        RVar[8u].z = RVar[4u].z;
        RVar[5u].w = clamp(_3250 * CBUFFER_3.values[42].x, 0.0, 1.0);
        float _3269 = RVar[127u].z;
        float _3276 = RVar[127u].y;
        float _3283 = RVar[126u].z;
        RVar[4u].x = clamp((_3248 * CBUFFER_3.values[22].z) + RVar[127u].w, 0.0, 1.0);
        RVar[2u].y = clamp((_3248 * CBUFFER_3.values[22].y) + _3269, 0.0, 1.0);
        RVar[4u].z = clamp((_3248 * CBUFFER_3.values[22].x) + _3276, 0.0, 1.0);
        RVar[1u].w = clamp((_3248 * CBUFFER_3.values[22].w) + _3283, 0.0, 1.0);
    }
    PARAM_0 = RVar[5u];
    PARAM_1 = RVar[8u];
    if (stateVar == 0)
    {
        float _3312 = RVar[2u].y;
        float _3315 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3312, 0.0, 1.0);
        float _3321 = RVar[4u].z;
        float _3324 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3321, 0.0, 1.0);
        RVar[123u].y = _3315;
        RVar[123u].z = _3324;
        float _3332 = RVar[1u].w;
        float _3342 = RVar[4u].x;
        float _3345 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3342, 0.0, 1.0);
        RVar[123u].w = _3345;
        float _3353 = RVar[7u].z;
        float _3360 = RVar[3u].x;
        RVar[1u].y = RVar[3u].y * max(_3315, uintBitsToFloat(1065353216u));
        RVar[1u].x = _3360 * max(_3324, uintBitsToFloat(1065353216u));
        float _3365 = RVar[7u].z;
        float _3369 = (_3365 * CBUFFER_4.values[17].z) + (_3353 * CBUFFER_4.values[17].w);
        float _3371 = RVar[3u].z;
        RVar[123u].x = _3369;
        RVar[1u].z = _3371 * max(_3345, uintBitsToFloat(1065353216u));
        RVar[1u].w = max(clamp(_3332 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u)) * CBUFFER_4.values[0].w;
        float _3394 = RVar[7u].z;
        RVar[0u].x = dot(vec4(RVar[6u].x, RVar[6u].y, _3369, uintBitsToFloat(0u)), vec4(CBUFFER_4.values[17].x, CBUFFER_4.values[17].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[0u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[7u].z, _3394 * CBUFFER_4.values[18].w), vec4(CBUFFER_4.values[18].x, CBUFFER_4.values[18].y, CBUFFER_4.values[18].z, uintBitsToFloat(1065353216u)));
        RVar[2u].x = dot(vec4(RVar[7u].x, RVar[7u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[20]);
        RVar[2u].y = dot(vec4(RVar[7u].x, RVar[7u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[21]);
        RVar[3u].x = dot(vec4(RVar[7u].x, RVar[7u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[23]);
        RVar[3u].y = dot(vec4(RVar[7u].x, RVar[7u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[24]);
        RVar[4u].x = dot(vec4(RVar[7u].x, RVar[7u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[26]);
        RVar[4u].y = dot(vec4(RVar[7u].x, RVar[7u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[27]);
        RVar[5u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[7u].z, RVar[7u].z), CBUFFER_4.values[29]);
        RVar[5u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[7u].z, RVar[7u].z), CBUFFER_4.values[30]);
    }
    PARAM_2 = RVar[1u];
