...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        float _299 = clamp((_274 + uintBitsToFloat(0u)) * 2.0, 0.0, 1.0);
        float _303 = clamp((_279 + uintBitsToFloat(0u)) * 2.0, 0.0, 1.0);
        float _307 = clamp((_284 + uintBitsToFloat(0u)) * 2.0, 0.0, 1.0);
        float _309 = RVar[2u].y;
        float _311 = RVar[127u].x;
        RVar[127u].y = _299;
        RVar[127u].z = _303;
        RVar[127u].w = _307;
        RVar[4u].y = (_309 * _311) + uintBitsToFloat(1056964608u);
        float _320 = RVar[1u].x;
        float _324 = RVar[1u].z;
        float _328 = RVar[1u].y;
        RVar[4u].z = (RVar[2u].z * RVar[127u].x) + uintBitsToFloat(1056964608u);
        float _346 = RVar[1u].w;
        float _348 = RVar[127u].z;
        float _352 = RVar[1u].w;
        float _354 = RVar[127u].y;
        RVar[3u].x = ((_320 + (-_307)) * RVar[1u].w) + RVar[127u].w;
        RVar[3u].y = ((_328 + (-_303)) * _346) + _348;
        RVar[3u].z = ((_324 + (-_299)) * _352) + _354;
        float _363 = RVar[4u].y;
        float _365 = RVar[4u].z;
        float _367 = RVar[4u].w;
        RVar[1u].x = RVar[4u].x;
        RVar[1u].y = _363;
        RVar[1u].z = _365;
        RVar[1u].w = _367;
        float _375 = RVar[3u].y;
        float _377 = RVar[3u].z;
        float _379 = RVar[3u].w;
        RVar[0u].x = RVar[3u].x;
        RVar[0u].y = _375;
        RVar[0u].z = _377;
        RVar[0u].w = _379;
