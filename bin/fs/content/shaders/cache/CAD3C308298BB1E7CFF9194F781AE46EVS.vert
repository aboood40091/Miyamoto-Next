...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[2u].x = dot(vec4(RVar[8u].x, RVar[2u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[20]);
        RVar[2u].y = dot(vec4(RVar[8u].x, RVar[2u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[21]);
    }
    PARAM_2 = RVar[1u];
