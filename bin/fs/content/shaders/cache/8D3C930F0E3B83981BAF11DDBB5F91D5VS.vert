...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[122u].x = _2731;
        float _2738 = RVar[20u].x;
        float _2740 = RVar[20u].x;
        float _2742 = (_2738 * _2740) + _2731;
        RVar[1u].x = CBUFFER_3.values[25].x;
        RVar[123u].y = _2742;
        RVar[1u].z = CBUFFER_3.values[25].z;
        RVar[1u].y = CBUFFER_3.values[25].y;
        vec4 _2752 = RVar[19u];
        float _2757 = inversesqrt(_2742);
        ...
        RVar[127u].z = _2766;
        RVar[127u].w = _2769;
        RVar[126u].x = (-dot(_2752, CBUFFER_3.values[2])) + (-CBUFFER_3.values[33].x);
    ...
    if (stateVar == 0)
    {
        ...
        float _3259 = RVar[127u].w;
        float _3266 = RVar[127u].x;
        float _3269 = clamp((_3238 * CBUFFER_3.values[22].y) + _3266, 0.0, 1.0);
        float _3273 = RVar[127u].z;
        float _3276 = clamp((_3238 * CBUFFER_3.values[22].x) + _3273, 0.0, 1.0);
        RVar[127u].x = clamp((_3238 * CBUFFER_3.values[22].w) + RVar[126u].w, 0.0, 1.0);
        RVar[127u].y = clamp((_3238 * CBUFFER_3.values[22].z) + _3259, 0.0, 1.0);
        RVar[123u].z = _3269;
        RVar[123u].w = _3276;
        float _3288 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3269, 0.0, 1.0);
        float _3295 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3276, 0.0, 1.0);
        RVar[123u].z = _3288;
        RVar[123u].w = _3295;
        float _3299 = RVar[127u].x;
        float _3309 = RVar[127u].y;
        float _3312 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3309, 0.0, 1.0);
        RVar[123u].y = _3312;
        float _3324 = RVar[5u].z;
        float _3328 = RVar[126u].x;
        float _3330 = (_3324 * CBUFFER_4.values[17].z) + _3328;
        RVar[2u].x = max(_3295, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].x;
        RVar[123u].z = _3330;
        RVar[2u].y = max(_3288, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].y;
        float _3340 = RVar[5u].y;
        float _3344 = (_3340 * CBUFFER_4.values[17].y) + _3330;
        RVar[123u].x = _3344;
        RVar[2u].z = max(_3312, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].z;
        RVar[2u].w = CBUFFER_4.values[0].w * max(clamp(_3299 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        float _3361 = RVar[5u].z;
        RVar[0u].x = (RVar[5u].x * CBUFFER_4.values[17].x) + _3344;
        RVar[0u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, _3361 * CBUFFER_4.values[18].w), vec4(CBUFFER_4.values[18].x, CBUFFER_4.values[18].y, CBUFFER_4.values[18].z, uintBitsToFloat(1065353216u)));
    }
    PARAM_2 = RVar[2u];
