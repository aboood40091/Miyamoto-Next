...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[127u].z = _2763;
        RVar[127u].w = _2766;
        RVar[2u].x = (-dot(_2749, CBUFFER_3.values[2])) + (-CBUFFER_3.values[34].x);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[7u].w = clamp(RVar[2u].x * CBUFFER_3.values[42].x, 0.0, 1.0);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[1u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[8u].z, _3431 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
