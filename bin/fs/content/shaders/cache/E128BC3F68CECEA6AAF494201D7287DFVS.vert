...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        float _3370 = RVar[5u].z;
        float _3374 = RVar[125u].x;
        float _3376 = (_3370 * CBUFFER_4.values[20].z) + _3374;
        RVar[123u].x = _3362;
        RVar[2u].z = _3364 * max(_3334, uintBitsToFloat(1065353216u));
        RVar[2u].w = _3367 * max(clamp(_3321 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        RVar[122u].x = _3376;
        float _3388 = RVar[5u].y;
        RVar[0u].x = (RVar[6u].x * CBUFFER_4.values[17].x) + _3362;
        RVar[125u].x = (_3388 * CBUFFER_4.values[20].y) + _3376;
        ...
        RVar[1u].y = dot(vec4(RVar[6u].x, RVar[5u].y, RVar[5u].z, _3417 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
    }
    PARAM_2 = RVar[2u];
