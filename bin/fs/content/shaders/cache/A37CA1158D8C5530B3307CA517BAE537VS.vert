...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[127u].w = _2766;
        float _2783 = RVar[20u].x;
        RVar[2u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[1u].z, RVar[1u].z), CBUFFER_4.values[18]);
        RVar[3u].x = _2783 * _2766;
        float _2793 = RVar[20u].z;
        float _2795 = RVar[127u].w;
        RVar[3u].y = RVar[20u].y * RVar[127u].w;
        RVar[3u].z = _2793 * _2795;
    }
    vec4 _2815 = (RVar[0u] * vec4(VS_PUSH.posMulAdd.xy, 1.0, 1.0)) + vec4(VS_PUSH.posMulAdd.zw, 0.0, 0.0);
    vec4 _2818 = _2815;
    _2818.y = -_2815.y;
    vec4 _2826 = _2818;
    _2826.z = (_2818.z + (_2818.w * VS_PUSH.zSpaceMul.x)) * VS_PUSH.zSpaceMul.y;
    gl_Position = _2826;
    PARAM_0 = RVar[3u];
