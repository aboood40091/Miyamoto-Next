...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[2u].w = max(clamp(_3325 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u)) * CBUFFER_4.values[0].w;
        float _3389 = RVar[6u].z;
        RVar[0u].x = dot(vec4(RVar[4u].x, RVar[4u].y, _3364, uintBitsToFloat(0u)), vec4(CBUFFER_4.values[17].x, CBUFFER_4.values[17].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[0u].y = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[6u].z, _3389 * CBUFFER_4.values[18].w), vec4(CBUFFER_4.values[18].x, CBUFFER_4.values[18].y, CBUFFER_4.values[18].z, uintBitsToFloat(1065353216u)));
        RVar[1u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[8u].z, RVar[8u].z), CBUFFER_4.values[20]);
        RVar[1u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[8u].z, RVar[8u].z), CBUFFER_4.values[21]);
