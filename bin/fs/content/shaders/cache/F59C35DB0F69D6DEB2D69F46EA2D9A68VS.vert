...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[2u].x = max(_3301, uintBitsToFloat(0u)) * CBUFFER_4.values[0].x;
        RVar[2u].y = max(_3294, uintBitsToFloat(0u)) * CBUFFER_4.values[0].y;
        RVar[122u].x = _3341;
        float _3346 = RVar[5u].y;
        float _3350 = (_3346 * CBUFFER_4.values[17].y) + _3341;
        RVar[123u].x = _3350;
        RVar[2u].z = max(_3314, uintBitsToFloat(0u)) * CBUFFER_4.values[0].z;
