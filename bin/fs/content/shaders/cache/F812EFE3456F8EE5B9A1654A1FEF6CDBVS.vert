...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[2u].x = dot(vec4(RVar[8u].x, RVar[2u].y, RVar[127u].x, uintBitsToFloat(0u)), vec4(CBUFFER_4.values[20].x, CBUFFER_4.values[20].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[2u].y = dot(vec4(RVar[8u].x, RVar[2u].y, RVar[6u].z, _3431 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
    }
    PARAM_2 = RVar[1u];
