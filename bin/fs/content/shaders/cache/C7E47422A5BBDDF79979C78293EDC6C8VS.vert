...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[6u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[4u].z, RVar[4u].z * CBUFFER_4.values[17].w), vec4(CBUFFER_4.values[17].x, CBUFFER_4.values[17].y, CBUFFER_4.values[17].z, uintBitsToFloat(1065353216u)));
        ...
        float _2781 = RVar[4u].z;
        RVar[127u].x = _2770;
        RVar[127u].y = _2773;
        RVar[127u].z = _2776;
        RVar[127u].w = _2779;
        RVar[3u].x = _2781 * CBUFFER_4.values[18].w;
        ...
        float _2869 = RVar[127u].x;
        float _2871 = (_2865 * CBUFFER_3.values[9].y) + _2869;
        RVar[123u].x = _2871;
        RVar[127u].y = (_2862 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[126u].z = (_2862 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        float _2890 = RVar[127u].z;
        float _2895 = (_2890 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2897 = RVar[127u].z;
        float _2902 = (_2897 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        float _2904 = RVar[1u].x;
        float _2908 = (_2904 * CBUFFER_3.values[9].x) + _2871;
        float _2910 = min(max(-dot(vec4(_2848, _2850, _2832 * CBUFFER_3.values[8].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[8].x, CBUFFER_3.values[8].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        RVar[123u].x = _2895;
        RVar[123u].y = _2902;
        RVar[123u].z = _2908;
        float _2927 = RVar[127u].y;
        RVar[127u].y = (_2910 * CBUFFER_3.values[16].y) + RVar[126u].z;
        RVar[126u].z = (_2910 * CBUFFER_3.values[16].x) + _2927;
        RVar[127u].w = (_2910 * CBUFFER_3.values[16].z) + _2902;
        RVar[126u].y = (_2910 * CBUFFER_3.values[16].w) + _2895;
        float _2943 = RVar[1u].x;
        float _2945 = RVar[1u].y;
        float _2947 = RVar[1u].z;
        float _2961 = min(max(-_2908, uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2971 = RVar[126u].z;
        float _2980 = RVar[127u].w;
        float _2986 = RVar[126u].y;
        RVar[127u].x = (_2961 * CBUFFER_3.values[17].y) + RVar[127u].y;
        RVar[127u].y = (_2961 * CBUFFER_3.values[17].x) + _2971;
        RVar[127u].w = (_2961 * CBUFFER_3.values[17].z) + _2980;
        RVar[126u].w = (_2961 * CBUFFER_3.values[17].w) + _2986;
        ...
        float _3025 = RVar[127u].w;
        float _3031 = RVar[127u].y;
        float _3037 = RVar[126u].w;
        RVar[127u].x = (_3012 * CBUFFER_3.values[18].y) + RVar[127u].x;
        RVar[126u].z = (_3012 * CBUFFER_3.values[18].z) + _3025;
        RVar[127u].w = (_3012 * CBUFFER_3.values[18].x) + _3031;
        RVar[126u].x = (_3012 * CBUFFER_3.values[18].w) + _3037;
        ...
        float _3074 = RVar[127u].x;
        float _3080 = RVar[126u].z;
        float _3089 = RVar[126u].x;
        RVar[127u].x = (_3063 * CBUFFER_3.values[19].x) + RVar[127u].w;
        RVar[127u].y = (_3063 * CBUFFER_3.values[19].y) + _3074;
        RVar[126u].z = (_3063 * CBUFFER_3.values[19].z) + _3080;
        RVar[127u].z = (_3063 * CBUFFER_3.values[19].w) + _3089;
        ...
        float _3123 = RVar[127u].y;
        float _3129 = RVar[127u].x;
        float _3135 = RVar[126u].z;
        float _3141 = RVar[127u].z;
        RVar[2u].x = max(-dot(vec4(RVar[1u].x, RVar[1u].y, RVar[1u].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[13].x, CBUFFER_3.values[13].y, CBUFFER_3.values[13].z, uintBitsToFloat(0u))), uintBitsToFloat(0u));
        RVar[2u].y = (_3115 * CBUFFER_3.values[20].y) + _3123;
        RVar[2u].z = (_3115 * CBUFFER_3.values[20].x) + _3129;
        RVar[1u].w = (_3115 * CBUFFER_3.values[20].z) + _3135;
        RVar[3u].y = (_3115 * CBUFFER_3.values[20].w) + _3141;
    }
    ...
    gl_Position = _3176;
    PARAM_0 = RVar[7u];
    PARAM_1 = vec4(RVar[4u].x, RVar[4u].x, RVar[4u].x, RVar[4u].w);
    if (stateVar == 0)
    {
        float _3191 = RVar[1u].x;
        float _3193 = RVar[1u].y;
        float _3195 = RVar[1u].z;
        float _3209 = RVar[2u].x;
        float _3211 = min(_3209, uintBitsToFloat(1065353216u));
        float _3222 = RVar[2u].z;
        float _3231 = RVar[1u].w;
        float _3237 = RVar[3u].y;
        RVar[127u].x = (_3211 * CBUFFER_3.values[21].y) + RVar[2u].y;
        RVar[127u].y = (_3211 * CBUFFER_3.values[21].x) + _3222;
        RVar[127u].w = (_3211 * CBUFFER_3.values[21].z) + _3231;
        RVar[126u].w = (_3211 * CBUFFER_3.values[21].w) + _3237;
        float _3245 = min(max(-dot(vec4(_3191, _3193, _3195, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[14].x, CBUFFER_3.values[14].y, CBUFFER_3.values[14].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3252 = RVar[4u].z;
        float _3256 = RVar[3u].x;
        RVar[126u].y = RVar[4u].z * CBUFFER_4.values[20].w;
        RVar[126u].x = (_3252 * CBUFFER_4.values[18].z) + _3256;
        float _3272 = RVar[127u].x;
        float _3275 = clamp((_3245 * CBUFFER_3.values[22].y) + _3272, 0.0, 1.0);
        float _3279 = RVar[127u].w;
        float _3286 = RVar[127u].y;
        float _3289 = clamp((_3245 * CBUFFER_3.values[22].x) + _3286, 0.0, 1.0);
        RVar[127u].x = clamp((_3245 * CBUFFER_3.values[22].w) + RVar[126u].w, 0.0, 1.0);
        RVar[123u].y = _3275;
        RVar[127u].z = clamp((_3245 * CBUFFER_3.values[22].z) + _3279, 0.0, 1.0);
        RVar[123u].w = _3289;
        float _3301 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3275, 0.0, 1.0);
        float _3308 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3289, 0.0, 1.0);
        RVar[123u].y = _3301;
        RVar[123u].w = _3308;
        float _3312 = RVar[127u].x;
        float _3324 = RVar[127u].z;
        float _3327 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3324, 0.0, 1.0);
        RVar[123u].z = _3327;
        float _3342 = RVar[5u].y;
        float _3346 = RVar[126u].x;
        float _3348 = (_3342 * CBUFFER_4.values[18].y) + _3346;
        RVar[3u].x = max(_3308, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].x;
        RVar[3u].y = max(_3301, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].y;
        RVar[122u].x = _3348;
        RVar[6u].y = (RVar[5u].x * CBUFFER_4.values[18].x) + _3348;
        RVar[3u].z = max(_3327, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].z;
        RVar[3u].w = CBUFFER_4.values[0].w * max(clamp(_3312 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        RVar[0u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[4u].z, RVar[126u].y), vec4(CBUFFER_4.values[20].x, CBUFFER_4.values[20].y, CBUFFER_4.values[20].z, uintBitsToFloat(1065353216u)));
        RVar[0u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[4u].z, RVar[4u].z), CBUFFER_4.values[21]);
    }
    PARAM_2 = RVar[3u];
    PARAM_3 = vec4(RVar[6u].x, RVar[6u].y, RVar[6u].z, RVar[6u].z);
