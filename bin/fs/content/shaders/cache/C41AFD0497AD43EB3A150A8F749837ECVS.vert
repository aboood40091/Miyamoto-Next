...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[2u].x = dot(vec4(RVar[5u].x, RVar[8u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[23]);
        RVar[2u].y = dot(vec4(RVar[5u].x, RVar[8u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[24]);
