...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[1u].w = clamp(_2836 * CBUFFER_3.values[41].x, 0.0, 1.0);
    ...
    if (stateVar == 0)
    {
        ...
        float _3267 = clamp((_3258 * CBUFFER_3.values[22].y) + _3264, 0.0, 1.0);
        float _3271 = RVar[127u].x;
        float _3274 = clamp((_3258 * CBUFFER_3.values[22].x) + _3271, 0.0, 1.0);
        float _3278 = RVar[126u].y;
        float _3285 = RVar[127u].z;
        RVar[123u].x = _3267;
        RVar[123u].y = _3274;
        RVar[127u].z = clamp((_3258 * CBUFFER_3.values[22].w) + _3278, 0.0, 1.0);
        RVar[127u].w = clamp((_3258 * CBUFFER_3.values[22].z) + _3285, 0.0, 1.0);
        ...
        float _3341 = RVar[5u].z;
        float _3345 = RVar[126u].x;
        float _3347 = (_3341 * CBUFFER_4.values[17].z) + _3345;
        RVar[2u].x = RVar[3u].x * max(_3307, uintBitsToFloat(1065353216u));
        RVar[2u].y = _3334 * max(_3300, uintBitsToFloat(1065353216u));
        RVar[122u].x = _3347;
        float _3352 = RVar[5u].y;
        float _3356 = (_3352 * CBUFFER_4.values[17].y) + _3347;
        float _3358 = RVar[3u].z;
        float _3361 = RVar[3u].w;
        RVar[123u].x = _3356;
        RVar[2u].z = _3358 * max(_3328, uintBitsToFloat(1065353216u));
        RVar[2u].w = _3361 * max(clamp(_3315 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        float _3373 = RVar[5u].z;
        RVar[0u].x = (RVar[6u].x * CBUFFER_4.values[17].x) + _3356;
        RVar[0u].y = dot(vec4(RVar[6u].x, RVar[5u].y, RVar[5u].z, _3373 * CBUFFER_4.values[18].w), vec4(CBUFFER_4.values[18].x, CBUFFER_4.values[18].y, CBUFFER_4.values[18].z, uintBitsToFloat(1065353216u)));
    }
    PARAM_2 = RVar[2u];
