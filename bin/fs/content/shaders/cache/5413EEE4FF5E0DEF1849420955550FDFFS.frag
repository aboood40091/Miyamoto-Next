...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[5u].w = clamp((_352 + (-uintBitsToFloat(1056964608u))) * 2.0, 0.0, 1.0);
        float _388 = RVar[1u].w;
        float _390 = RVar[127u].y;
        float _394 = RVar[1u].w;
        float _396 = RVar[126u].x;
        float _400 = RVar[126u].y;
        float _403 = inversesqrt(_400) * 0.5;
        RVar[5u].x = ((_356 + (-_358)) * RVar[1u].w) + RVar[127u].z;
        RVar[5u].y = ((_368 + (-_370)) * _388) + _390;
        RVar[5u].z = ((_362 + (-_364)) * _394) + _396;
        float _408 = RVar[2u].x;
        float _411 = (_408 * _403) + uintBitsToFloat(1056964608u);
        float _413 = RVar[2u].y;
        float _416 = (_413 * _403) + uintBitsToFloat(1056964608u);
        float _418 = RVar[2u].z;
        float _421 = (_418 * _403) + uintBitsToFloat(1056964608u);
        RVar[4u].x = _411;
        RVar[4u].y = _416;
        RVar[4u].z = _421;
        float _426 = RVar[4u].w;
        RVar[1u].x = _411;
        RVar[1u].y = _416;
        RVar[1u].z = _421;
        RVar[1u].w = _426;
        float _434 = RVar[5u].y;
        float _436 = RVar[5u].z;
        float _438 = RVar[5u].w;
        RVar[0u].x = RVar[5u].x;
        RVar[0u].y = _434;
        RVar[0u].z = _436;
        RVar[0u].w = _438;
    ...
    _pixelTmp_1 = RVar[1u];
    uint _542 = PS_PUSH.alphaFunc >> 8u;
    if (_542 == 1u)
    {
