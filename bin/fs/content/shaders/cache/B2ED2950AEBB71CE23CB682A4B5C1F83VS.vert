...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[122u].x = _2732;
        float _2739 = RVar[21u].x;
        float _2741 = RVar[21u].x;
        float _2743 = (_2739 * _2741) + _2732;
        RVar[1u].x = CBUFFER_3.values[26].x;
        RVar[123u].y = _2743;
        RVar[1u].z = CBUFFER_3.values[26].z;
        RVar[1u].y = CBUFFER_3.values[26].y;
        vec4 _2753 = RVar[20u];
        float _2758 = inversesqrt(_2743);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[126u].x = RVar[6u].z * CBUFFER_4.values[17].w;
        float _3260 = RVar[127u].w;
        float _3267 = RVar[127u].x;
        float _3270 = clamp((_3239 * CBUFFER_3.values[22].y) + _3267, 0.0, 1.0);
        float _3274 = RVar[127u].z;
        float _3277 = clamp((_3239 * CBUFFER_3.values[22].x) + _3274, 0.0, 1.0);
        RVar[127u].x = clamp((_3239 * CBUFFER_3.values[22].w) + RVar[126u].w, 0.0, 1.0);
        RVar[127u].y = clamp((_3239 * CBUFFER_3.values[22].z) + _3260, 0.0, 1.0);
        RVar[123u].z = _3270;
        RVar[123u].w = _3277;
        float _3289 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3270, 0.0, 1.0);
        float _3296 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3277, 0.0, 1.0);
        RVar[123u].z = _3289;
        RVar[123u].w = _3296;
        float _3300 = RVar[127u].x;
        float _3310 = RVar[127u].y;
        float _3313 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3310, 0.0, 1.0);
        RVar[123u].y = _3313;
        float _3325 = RVar[6u].z;
        float _3329 = RVar[126u].x;
        float _3331 = (_3325 * CBUFFER_4.values[17].z) + _3329;
        float _3335 = RVar[3u].y;
        RVar[2u].x = RVar[3u].x * max(_3296, uintBitsToFloat(1065353216u));
        RVar[123u].z = _3331;
        RVar[2u].y = _3335 * max(_3289, uintBitsToFloat(1065353216u));
        float _3341 = RVar[6u].y;
        float _3345 = (_3341 * CBUFFER_4.values[17].y) + _3331;
        float _3347 = RVar[3u].z;
        float _3350 = RVar[3u].w;
        RVar[123u].x = _3345;
        RVar[2u].z = _3347 * max(_3313, uintBitsToFloat(1065353216u));
        RVar[2u].w = _3350 * max(clamp(_3300 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        float _3362 = RVar[6u].z;
        RVar[0u].x = (RVar[6u].x * CBUFFER_4.values[17].x) + _3345;
        RVar[0u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[6u].z, _3362 * CBUFFER_4.values[18].w), vec4(CBUFFER_4.values[18].x, CBUFFER_4.values[18].y, CBUFFER_4.values[18].z, uintBitsToFloat(1065353216u)));
    }
    PARAM_2 = RVar[2u];
