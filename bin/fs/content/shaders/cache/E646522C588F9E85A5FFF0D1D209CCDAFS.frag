...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        float _289 = (CBUFFER_1.values[5].x * uintBitsToFloat(1065353216u)) + uintBitsToFloat(0u);
        float _295 = (CBUFFER_1.values[5].y * uintBitsToFloat(1065353216u)) + uintBitsToFloat(0u);
        float _304 = RVar[127u].y;
        RVar[123u].x = _289;
        RVar[123u].y = _295;
        RVar[127u].w = (CBUFFER_1.values[5].z * uintBitsToFloat(1065353216u)) + uintBitsToFloat(0u);
    ...
    if (stateVar == 0)
    {
        ...
        float _533 = (CBUFFER_1.values[4].w * clamp(clamp(_493 + uintBitsToFloat(0u), 0.0, 1.0) + _525, 0.0, 1.0)) + uintBitsToFloat(0u);
        RVar[123u].y = _533;
        RVar[6u].w = clamp(_533 + uintBitsToFloat(0u), 0.0, 1.0);
        float _542 = RVar[9u].y;
        float _544 = RVar[9u].z;
        float _546 = RVar[9u].w;
        RVar[1u].x = RVar[9u].x;
        RVar[1u].y = _542;
        RVar[1u].z = _544;
        RVar[1u].w = _546;
        float _554 = RVar[6u].y;
        float _556 = RVar[6u].z;
        float _558 = RVar[6u].w;
        RVar[0u].x = RVar[6u].x;
        RVar[0u].y = _554;
        RVar[0u].z = _556;
        RVar[0u].w = _558;
    ...
    _pixelTmp = RVar[0u];
    uint _633 = PS_PUSH.alphaFunc >> 8u;
    if (_633 == 1u)
    {
        _pixelTmp = vec4(1.0);
    }
    ...
    _pixelTmp_1 = RVar[1u];
    uint _661 = PS_PUSH.alphaFunc >> 8u;
    if (_661 == 1u)
    {
