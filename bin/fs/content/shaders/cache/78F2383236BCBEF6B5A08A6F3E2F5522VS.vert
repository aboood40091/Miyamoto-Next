...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[1u].x = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[20]);
        RVar[1u].y = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[21]);
        RVar[3u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[8u].z, RVar[8u].z), CBUFFER_4.values[23]);
        RVar[3u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[8u].z, RVar[8u].z), CBUFFER_4.values[24]);
    }
    PARAM_2 = RVar[2u];
