...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[122u].x = _2731;
        float _2735 = RVar[20u].x;
        float _2737 = RVar[20u].x;
        float _2739 = (_2735 * _2737) + _2731;
        RVar[123u].x = _2739;
        RVar[1u].y = CBUFFER_3.values[26].y;
        RVar[1u].z = CBUFFER_3.values[26].z;
        RVar[1u].x = CBUFFER_3.values[26].x;
        vec4 _2752 = RVar[19u];
        float _2757 = inversesqrt(_2739);
        ...
        RVar[2u].x = dot(vec4(_2760, _2763, _2766, _2769), CBUFFER_3.values[0]);
        RVar[6u].x = _2760;
        float _2793 = RVar[127u].y;
        RVar[2u].y = dot(RVar[127u], CBUFFER_3.values[1]);
        RVar[6u].y = _2793;
        vec4 _2797 = RVar[127u];
        float _2800 = dot(_2797, CBUFFER_3.values[2]);
        float _2802 = RVar[127u].z;
        RVar[2u].z = _2800;
        RVar[6u].z = _2802;
        float _2806 = RVar[2u].x;
        float _2808 = RVar[2u].y;
        float _2833 = RVar[2u].z;
        RVar[1u].w = clamp(RVar[126u].x * CBUFFER_3.values[42].x, 0.0, 1.0);
        float _2840 = RVar[2u].x;
        float _2842 = RVar[2u].y;
        float _2854 = min(max(-dot(vec4(_2806, _2808, _2800, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[7].x, CBUFFER_3.values[7].y, CBUFFER_3.values[7].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        RVar[126u].x = (_2854 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        RVar[127u].z = (_2854 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[127u].w = (_2854 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        RVar[126u].w = (_2854 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2884 = RVar[2u].x;
        float _2886 = RVar[2u].y;
        float _2888 = RVar[2u].z;
        float _2902 = min(max(-dot(vec4(_2840, _2842, _2833 * CBUFFER_3.values[8].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[8].x, CBUFFER_3.values[8].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2913 = RVar[127u].w;
        float _2922 = RVar[127u].z;
        float _2928 = RVar[126u].w;
        RVar[126u].x = (_2902 * CBUFFER_3.values[16].y) + RVar[126u].x;
        RVar[127u].y = (_2902 * CBUFFER_3.values[16].z) + _2913;
        RVar[127u].w = (_2902 * CBUFFER_3.values[16].x) + _2922;
        RVar[127u].x = (_2902 * CBUFFER_3.values[16].w) + _2928;
        float _2936 = RVar[2u].x;
        float _2938 = RVar[2u].y;
        float _2940 = RVar[2u].z;
        float _2954 = min(max(-dot(vec4(_2884, _2886, _2888, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[9].x, CBUFFER_3.values[9].y, CBUFFER_3.values[9].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2965 = RVar[126u].x;
        float _2971 = RVar[127u].y;
        float _2980 = RVar[127u].x;
        RVar[127u].x = (_2954 * CBUFFER_3.values[17].x) + RVar[127u].w;
        RVar[127u].y = (_2954 * CBUFFER_3.values[17].y) + _2965;
        RVar[127u].z = (_2954 * CBUFFER_3.values[17].z) + _2971;
        RVar[126u].y = (_2954 * CBUFFER_3.values[17].w) + _2980;
        float _2988 = RVar[2u].x;
        float _2990 = RVar[2u].y;
        float _2992 = RVar[2u].z;
        float _3006 = min(max(-dot(vec4(_2936, _2938, _2940, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[10].x, CBUFFER_3.values[10].y, CBUFFER_3.values[10].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3020 = RVar[127u].y;
        float _3026 = RVar[127u].z;
        float _3032 = RVar[126u].y;
        RVar[127u].y = (_3006 * CBUFFER_3.values[18].x) + RVar[127u].x;
        RVar[127u].z = (_3006 * CBUFFER_3.values[18].y) + _3020;
        RVar[127u].w = (_3006 * CBUFFER_3.values[18].z) + _3026;
        RVar[126u].z = (_3006 * CBUFFER_3.values[18].w) + _3032;
        float _3040 = RVar[2u].x;
        float _3042 = RVar[2u].y;
        float _3044 = RVar[2u].z;
        float _3058 = min(max(-dot(vec4(_2988, _2990, _2992, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[11].x, CBUFFER_3.values[11].y, CBUFFER_3.values[11].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3072 = RVar[127u].y;
        float _3078 = RVar[127u].w;
        float _3084 = RVar[126u].z;
        RVar[127u].x = (_3058 * CBUFFER_3.values[19].y) + RVar[127u].z;
        RVar[127u].z = (_3058 * CBUFFER_3.values[19].x) + _3072;
        RVar[127u].w = (_3058 * CBUFFER_3.values[19].z) + _3078;
        RVar[126u].w = (_3058 * CBUFFER_3.values[19].w) + _3084;
        float _3092 = RVar[2u].x;
        float _3094 = RVar[2u].y;
        float _3096 = RVar[2u].z;
        float _3110 = min(max(-dot(vec4(_3040, _3042, _3044, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[12].x, CBUFFER_3.values[12].y, CBUFFER_3.values[12].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3121 = RVar[127u].w;
        float _3130 = RVar[127u].z;
        float _3136 = RVar[126u].w;
        RVar[3u].x = (_3110 * CBUFFER_3.values[20].y) + RVar[127u].x;
        RVar[3u].y = (_3110 * CBUFFER_3.values[20].z) + _3121;
        RVar[3u].z = max(-dot(vec4(_3092, _3094, _3096, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[13].x, CBUFFER_3.values[13].y, CBUFFER_3.values[13].z, uintBitsToFloat(0u))), uintBitsToFloat(0u));
        RVar[2u].w = (_3110 * CBUFFER_3.values[20].x) + _3130;
        RVar[4u].x = (_3110 * CBUFFER_3.values[20].w) + _3136;
    }
    vec4 _3159 = (RVar[0u] * vec4(VS_PUSH.posMulAdd.xy, 1.0, 1.0)) + vec4(VS_PUSH.posMulAdd.zw, 0.0, 0.0);
    vec4 _3162 = _3159;
    _3162.y = -_3159.y;
    vec4 _3170 = _3162;
    _3170.z = (_3162.z + (_3162.w * VS_PUSH.zSpaceMul.x)) * VS_PUSH.zSpaceMul.y;
    gl_Position = _3170;
    PARAM_0 = RVar[1u];
    PARAM_1 = RVar[6u];
    if (stateVar == 0)
    {
        ...
        float _3186 = RVar[2u].y;
        float _3188 = RVar[2u].z;
        float _3202 = RVar[3u].z;
        float _3204 = min(_3202, uintBitsToFloat(1065353216u));
        float _3215 = RVar[3u].x;
        float _3221 = RVar[3u].y;
        float _3230 = RVar[4u].x;
        RVar[127u].x = (_3204 * CBUFFER_3.values[21].x) + RVar[2u].w;
        RVar[127u].y = (_3204 * CBUFFER_3.values[21].y) + _3215;
        RVar[127u].z = (_3204 * CBUFFER_3.values[21].z) + _3221;
        RVar[126u].y = (_3204 * CBUFFER_3.values[21].w) + _3230;
        float _3246 = min(max(-dot(vec4(_3184, _3186, _3188, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[14].x, CBUFFER_3.values[14].y, CBUFFER_3.values[14].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3248 = RVar[4u].z;
        RVar[126u].x = RVar[4u].z * CBUFFER_4.values[17].w;
        RVar[125u].x = _3248 * CBUFFER_4.values[20].w;
        float _3258 = RVar[127u].y;
        float _3261 = clamp((_3246 * CBUFFER_3.values[22].y) + _3258, 0.0, 1.0);
        float _3265 = RVar[127u].x;
        float _3268 = clamp((_3246 * CBUFFER_3.values[22].x) + _3265, 0.0, 1.0);
        float _3272 = RVar[126u].y;
        float _3279 = RVar[127u].z;
        RVar[123u].x = _3261;
        RVar[123u].y = _3268;
        RVar[127u].z = clamp((_3246 * CBUFFER_3.values[22].w) + _3272, 0.0, 1.0);
        RVar[127u].w = clamp((_3246 * CBUFFER_3.values[22].z) + _3279, 0.0, 1.0);
        float _3294 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3261, 0.0, 1.0);
        float _3301 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3268, 0.0, 1.0);
        RVar[123u].x = _3294;
        RVar[123u].y = _3301;
        float _3309 = RVar[127u].z;
        float _3319 = RVar[127u].w;
        float _3322 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3319, 0.0, 1.0);
        RVar[123u].w = _3322;
        float _3335 = RVar[4u].z;
        float _3339 = RVar[126u].x;
        float _3341 = (_3335 * CBUFFER_4.values[17].z) + _3339;
        RVar[2u].x = max(_3301, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].x;
        RVar[2u].y = max(_3294, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].y;
        RVar[122u].x = _3341;
        float _3346 = RVar[5u].y;
        float _3350 = (_3346 * CBUFFER_4.values[17].y) + _3341;
        RVar[123u].x = _3350;
        RVar[2u].z = max(_3322, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].z;
        RVar[2u].w = CBUFFER_4.values[0].w * max(clamp(_3309 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        float _3367 = RVar[4u].z;
        float _3371 = RVar[125u].x;
        RVar[0u].x = (RVar[5u].x * CBUFFER_4.values[17].x) + _3350;
        RVar[125u].x = (_3367 * CBUFFER_4.values[20].z) + _3371;
        RVar[0u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[4u].z, RVar[4u].z), CBUFFER_4.values[18]);
        float _3406 = RVar[4u].z;
        RVar[1u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[125u].x, uintBitsToFloat(0u)), vec4(CBUFFER_4.values[20].x, CBUFFER_4.values[20].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[1u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[4u].z, _3406 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
    }
    PARAM_2 = RVar[2u];
