...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[127u].z = _2767;
        RVar[127u].w = _2770;
        RVar[126u].x = (-dot(_2753, CBUFFER_3.values[2])) + (-CBUFFER_3.values[33].x);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[2u].w = max(clamp(_3310 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u)) * CBUFFER_4.values[0].w;
        float _3368 = RVar[5u].z;
        float _3372 = RVar[125u].x;
        RVar[0u].x = (RVar[6u].x * CBUFFER_4.values[17].x) + _3351;
        RVar[125u].x = (_3368 * CBUFFER_4.values[20].z) + _3372;
        RVar[0u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[18]);
        float _3407 = RVar[5u].z;
        RVar[1u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[125u].x, uintBitsToFloat(0u)), vec4(CBUFFER_4.values[20].x, CBUFFER_4.values[20].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[1u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, _3407 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
