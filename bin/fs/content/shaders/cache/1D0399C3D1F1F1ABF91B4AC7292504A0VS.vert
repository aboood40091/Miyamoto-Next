...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[8u].x = uintBitsToFloat(1065353216u);
        RVar[0u].w = dot(RVar[20u], CBUFFER_3.values[6]);
        RVar[8u].w = uintBitsToFloat(0u);
        vec4 _2723 = RVar[21u];
        vec4 _2725 = RVar[21u];
        float _2753 = inversesqrt(dot(_2723, _2725));
        RVar[9u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[6u].z, RVar[6u].z * CBUFFER_4.values[17].w), vec4(CBUFFER_4.values[17].x, CBUFFER_4.values[17].y, CBUFFER_4.values[17].z, uintBitsToFloat(1065353216u)));
        float _2756 = RVar[21u].x;
        float _2757 = _2756 * _2753;
        float _2759 = RVar[21u].y;
        float _2760 = _2759 * _2753;
        float _2762 = RVar[21u].z;
        float _2763 = _2762 * _2753;
        float _2765 = RVar[21u].w;
        float _2766 = _2765 * _2753;
        float _2768 = RVar[6u].z;
        RVar[127u].x = _2757;
        RVar[127u].y = _2760;
        RVar[127u].z = _2763;
        RVar[127u].w = _2766;
        RVar[5u].x = _2768 * CBUFFER_4.values[18].w;
        ...
        RVar[1u].y = _2788;
        RVar[7u].x = (_2781 * uintBitsToFloat(1056964608u)) + uintBitsToFloat(1056964608u);
        vec4 _2797 = RVar[127u];
        float _2800 = dot(_2797, CBUFFER_3.values[2]);
        RVar[1u].z = _2800;
        RVar[4u].y = ((-_2788) * uintBitsToFloat(1056964608u)) + uintBitsToFloat(1056964608u);
        float _2809 = RVar[1u].x;
        float _2811 = RVar[1u].y;
        RVar[10u].y = RVar[127u].y;
        float _2837 = RVar[127u].z;
        float _2839 = RVar[1u].z;
        RVar[127u].y = RVar[1u].z * CBUFFER_3.values[9].z;
        RVar[10u].z = _2837;
        float _2847 = RVar[1u].x;
        float _2849 = RVar[1u].y;
        float _2861 = min(max(-dot(vec4(_2809, _2811, _2800, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[7].x, CBUFFER_3.values[7].y, CBUFFER_3.values[7].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        RVar[126u].y = _2861;
        float _2864 = RVar[1u].y;
        float _2868 = RVar[127u].y;
        float _2870 = (_2864 * CBUFFER_3.values[9].y) + _2868;
        RVar[123u].x = _2870;
        RVar[127u].y = (_2861 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        RVar[127u].w = (_2861 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        float _2889 = RVar[126u].y;
        float _2894 = (_2889 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        float _2896 = RVar[1u].x;
        float _2900 = (_2896 * CBUFFER_3.values[9].x) + _2870;
        float _2902 = RVar[126u].y;
        float _2907 = (_2902 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2909 = min(max(-dot(vec4(_2847, _2849, _2839 * CBUFFER_3.values[8].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[8].x, CBUFFER_3.values[8].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        RVar[123u].x = _2894;
        RVar[123u].y = _2900;
        RVar[123u].z = _2907;
        float _2923 = RVar[127u].w;
        RVar[127u].x = (_2909 * CBUFFER_3.values[16].y) + RVar[127u].y;
        RVar[127u].y = (_2909 * CBUFFER_3.values[16].x) + _2923;
        RVar[127u].z = (_2909 * CBUFFER_3.values[16].z) + _2894;
        RVar[126u].x = (_2909 * CBUFFER_3.values[16].w) + _2907;
        float _2942 = RVar[1u].x;
        float _2944 = RVar[1u].y;
        float _2946 = RVar[1u].z;
        float _2960 = min(max(-_2900, uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2973 = RVar[127u].x;
        float _2979 = RVar[127u].z;
        float _2985 = RVar[126u].x;
        RVar[127u].x = (_2960 * CBUFFER_3.values[17].x) + RVar[127u].y;
        RVar[127u].z = (_2960 * CBUFFER_3.values[17].y) + _2973;
        RVar[127u].w = (_2960 * CBUFFER_3.values[17].z) + _2979;
        RVar[126u].z = (_2960 * CBUFFER_3.values[17].w) + _2985;
        float _2993 = RVar[1u].x;
        float _2995 = RVar[1u].y;
        float _2997 = RVar[1u].z;
        float _3011 = min(max(-dot(vec4(_2942, _2944, _2946, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[10].x, CBUFFER_3.values[10].y, CBUFFER_3.values[10].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3024 = RVar[127u].x;
        float _3030 = RVar[127u].w;
        float _3036 = RVar[126u].z;
        RVar[127u].y = (_3011 * CBUFFER_3.values[18].y) + RVar[127u].z;
        RVar[127u].z = (_3011 * CBUFFER_3.values[18].x) + _3024;
        RVar[127u].w = (_3011 * CBUFFER_3.values[18].z) + _3030;
        RVar[126u].w = (_3011 * CBUFFER_3.values[18].w) + _3036;
        float _3044 = RVar[1u].x;
        float _3046 = RVar[1u].y;
        float _3048 = RVar[1u].z;
        float _3062 = min(max(-dot(vec4(_2993, _2995, _2997, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[11].x, CBUFFER_3.values[11].y, CBUFFER_3.values[11].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3073 = RVar[127u].w;
        float _3082 = RVar[127u].z;
        float _3088 = RVar[126u].w;
        RVar[127u].x = (_3062 * CBUFFER_3.values[19].y) + RVar[127u].y;
        RVar[127u].y = (_3062 * CBUFFER_3.values[19].z) + _3073;
        RVar[127u].w = (_3062 * CBUFFER_3.values[19].x) + _3082;
        RVar[126u].y = (_3062 * CBUFFER_3.values[19].w) + _3088;
        float _3096 = RVar[1u].x;
        float _3098 = RVar[1u].y;
        float _3100 = RVar[1u].z;
        float _3114 = min(max(-dot(vec4(_3044, _3046, _3048, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[12].x, CBUFFER_3.values[12].y, CBUFFER_3.values[12].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3125 = RVar[127u].w;
        float _3131 = RVar[127u].y;
        float _3140 = RVar[126u].y;
        RVar[2u].x = (_3114 * CBUFFER_3.values[20].y) + RVar[127u].x;
        RVar[2u].y = (_3114 * CBUFFER_3.values[20].x) + _3125;
        RVar[2u].z = (_3114 * CBUFFER_3.values[20].z) + _3131;
        RVar[1u].w = max(-dot(vec4(_3096, _3098, _3100, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[13].x, CBUFFER_3.values[13].y, CBUFFER_3.values[13].z, uintBitsToFloat(0u))), uintBitsToFloat(0u));
        RVar[4u].x = (_3114 * CBUFFER_3.values[20].w) + _3140;
    }
    vec4 _3164 = (RVar[0u] * vec4(VS_PUSH.posMulAdd.xy, 1.0, 1.0)) + vec4(VS_PUSH.posMulAdd.zw, 0.0, 0.0);
    vec4 _3167 = _3164;
    _3167.y = -_3164.y;
    vec4 _3175 = _3167;
    _3175.z = (_3167.z + (_3167.w * VS_PUSH.zSpaceMul.x)) * VS_PUSH.zSpaceMul.y;
    gl_Position = _3175;
    PARAM_0 = RVar[10u];
    PARAM_1 = vec4(RVar[8u].x, RVar[8u].x, RVar[8u].x, RVar[8u].w);
    if (stateVar == 0)
    {
        float _3190 = RVar[1u].x;
        float _3192 = RVar[1u].y;
        float _3194 = RVar[1u].z;
        float _3208 = RVar[1u].w;
        float _3210 = min(_3208, uintBitsToFloat(1065353216u));
        float _3224 = RVar[2u].x;
        float _3230 = RVar[2u].z;
        float _3236 = RVar[4u].x;
        RVar[127u].x = (_3210 * CBUFFER_3.values[21].x) + RVar[2u].y;
        RVar[127u].z = (_3210 * CBUFFER_3.values[21].y) + _3224;
        RVar[127u].w = (_3210 * CBUFFER_3.values[21].z) + _3230;
        RVar[126u].z = (_3210 * CBUFFER_3.values[21].w) + _3236;
        float _3252 = min(max(-dot(vec4(_3190, _3192, _3194, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[14].x, CBUFFER_3.values[14].y, CBUFFER_3.values[14].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3254 = RVar[6u].z;
        RVar[126u].x = (RVar[6u].z * CBUFFER_4.values[18].z) + RVar[5u].x;
        RVar[125u].x = _3254 * CBUFFER_4.values[20].w;
        float _3264 = RVar[127u].z;
        float _3267 = clamp((_3252 * CBUFFER_3.values[22].y) + _3264, 0.0, 1.0);
        float _3271 = RVar[127u].w;
        float _3278 = RVar[127u].x;
        float _3281 = clamp((_3252 * CBUFFER_3.values[22].x) + _3278, 0.0, 1.0);
        float _3285 = RVar[126u].z;
        RVar[123u].x = _3267;
        RVar[127u].y = clamp((_3252 * CBUFFER_3.values[22].z) + _3271, 0.0, 1.0);
        RVar[123u].z = _3281;
        RVar[127u].w = clamp((_3252 * CBUFFER_3.values[22].w) + _3285, 0.0, 1.0);
        float _3300 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3267, 0.0, 1.0);
        float _3307 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3281, 0.0, 1.0);
        RVar[123u].x = _3300;
        RVar[123u].z = _3307;
        float _3317 = RVar[127u].y;
        float _3320 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3317, 0.0, 1.0);
        float _3324 = RVar[127u].w;
        RVar[123u].y = _3320;
        float _3334 = RVar[3u].y;
        float _3341 = RVar[6u].y;
        float _3345 = RVar[126u].x;
        float _3347 = (_3341 * CBUFFER_4.values[18].y) + _3345;
        RVar[5u].x = RVar[3u].x * max(_3307, uintBitsToFloat(1065353216u));
        RVar[5u].y = _3334 * max(_3300, uintBitsToFloat(1065353216u));
        RVar[122u].x = _3347;
        float _3352 = RVar[6u].z;
        float _3356 = RVar[125u].x;
        float _3358 = (_3352 * CBUFFER_4.values[20].z) + _3356;
        float _3360 = RVar[6u].x;
        float _3366 = RVar[3u].z;
        float _3369 = RVar[3u].w;
        RVar[123u].x = _3358;
        RVar[9u].y = (_3360 * CBUFFER_4.values[18].x) + _3347;
        RVar[5u].z = _3366 * max(_3320, uintBitsToFloat(1065353216u));
        RVar[5u].w = _3369 * max(clamp(_3324 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        float _3390 = RVar[6u].z;
        RVar[0u].x = dot(vec4(RVar[6u].x, RVar[6u].y, _3358, uintBitsToFloat(0u)), vec4(CBUFFER_4.values[20].x, CBUFFER_4.values[20].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[0u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[6u].z, _3390 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
        RVar[1u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[23]);
        RVar[1u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[24]);
        RVar[2u].x = dot(vec4(RVar[7u].x, RVar[4u].y, RVar[4u].z, RVar[4u].z), CBUFFER_4.values[26]);
        RVar[2u].y = dot(vec4(RVar[7u].x, RVar[4u].y, RVar[4u].z, RVar[4u].z), CBUFFER_4.values[27]);
    }
    PARAM_2 = RVar[5u];
    PARAM_3 = vec4(RVar[9u].x, RVar[9u].y, RVar[9u].z, RVar[9u].z);
