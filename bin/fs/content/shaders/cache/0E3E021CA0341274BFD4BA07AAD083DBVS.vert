...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[7u].x = CBUFFER_3.values[25].x;
        vec4 _2749 = RVar[20u];
        ...
        RVar[127u].z = _2763;
        RVar[127u].w = _2766;
        RVar[2u].x = (-dot(_2749, CBUFFER_3.values[2])) + (-CBUFFER_3.values[33].x);
        ...
        RVar[2u].y = _2788;
        RVar[4u].x = (_2781 * uintBitsToFloat(1056964608u)) + uintBitsToFloat(1056964608u);
        ...
        float _2811 = RVar[2u].y;
        RVar[9u].y = RVar[127u].y;
        float _2835 = RVar[127u].z;
        RVar[7u].y = CBUFFER_3.values[25].y;
        RVar[7u].z = CBUFFER_3.values[25].z;
        RVar[9u].z = _2835;
        float _2840 = RVar[1u].x;
        ...
        RVar[127u].y = (_2858 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[127u].z = (_2858 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        RVar[127u].w = (_2858 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        RVar[126u].z = (_2858 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2888 = RVar[1u].x;
        float _2890 = RVar[2u].y;
        ...
        RVar[127u].x = (_2906 * CBUFFER_3.values[16].y) + RVar[127u].z;
        RVar[127u].z = (_2906 * CBUFFER_3.values[16].x) + _2920;
        RVar[127u].w = (_2906 * CBUFFER_3.values[16].z) + _2926;
        RVar[126u].w = (_2906 * CBUFFER_3.values[16].w) + _2932;
        float _2940 = RVar[1u].x;
        float _2942 = RVar[2u].y;
        ...
        float _2969 = RVar[127u].w;
        float _2978 = RVar[127u].z;
        float _2984 = RVar[126u].w;
        RVar[127u].x = (_2958 * CBUFFER_3.values[17].y) + RVar[127u].x;
        RVar[127u].y = (_2958 * CBUFFER_3.values[17].z) + _2969;
        RVar[127u].w = (_2958 * CBUFFER_3.values[17].x) + _2978;
        RVar[126u].x = (_2958 * CBUFFER_3.values[17].w) + _2984;
        float _2992 = RVar[1u].x;
        float _2994 = RVar[2u].y;
        ...
        float _3021 = RVar[127u].x;
        float _3027 = RVar[127u].y;
        float _3036 = RVar[126u].x;
        RVar[127u].x = (_3010 * CBUFFER_3.values[18].x) + RVar[127u].w;
        RVar[127u].y = (_3010 * CBUFFER_3.values[18].y) + _3021;
        RVar[127u].z = (_3010 * CBUFFER_3.values[18].z) + _3027;
        RVar[126u].y = (_3010 * CBUFFER_3.values[18].w) + _3036;
        float _3044 = RVar[1u].x;
        float _3046 = RVar[2u].y;
        ...
        float _3088 = RVar[126u].y;
        RVar[1u].y = (_3062 * CBUFFER_3.values[19].x) + RVar[127u].x;
        RVar[2u].z = (_3062 * CBUFFER_3.values[19].y) + _3076;
    ...
    if (stateVar == 0)
    {
        ...
        RVar[127u].z = (_3168 * CBUFFER_3.values[20].x) + _3172;
        RVar[127u].w = (_3176 * CBUFFER_3.values[20].z) + _3180;
        RVar[126u].w = (_3184 * CBUFFER_3.values[20].w) + _3188;
        float _3196 = RVar[1u].x;
        float _3198 = RVar[2u].y;
        float _3200 = RVar[5u].z;
        float _3214 = min(max(-_3163, uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3225 = RVar[127u].w;
        float _3234 = RVar[127u].z;
        float _3240 = RVar[126u].w;
        RVar[127u].x = (_3214 * CBUFFER_3.values[21].y) + RVar[127u].x;
        RVar[127u].y = (_3214 * CBUFFER_3.values[21].z) + _3225;
        RVar[127u].w = (_3214 * CBUFFER_3.values[21].x) + _3234;
        RVar[126u].x = (_3214 * CBUFFER_3.values[21].w) + _3240;
        ...
        RVar[7u].w = clamp(RVar[2u].x * CBUFFER_3.values[41].x, 0.0, 1.0);
        float _3268 = RVar[126u].x;
        float _3275 = RVar[127u].y;
        float _3282 = RVar[127u].x;
        RVar[2u].x = clamp((_3248 * CBUFFER_3.values[22].x) + RVar[127u].w, 0.0, 1.0);
        RVar[2u].y = clamp((_3248 * CBUFFER_3.values[22].w) + _3268, 0.0, 1.0);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[123u].x = _3310;
        RVar[123u].w = _3319;
        float _3325 = RVar[2u].y;
        float _3335 = RVar[5u].z;
        float _3338 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3335, 0.0, 1.0);
        RVar[123u].z = _3338;
        float _3348 = RVar[8u].z;
        float _3355 = RVar[3u].x;
        RVar[2u].y = RVar[3u].y * max(_3319, uintBitsToFloat(1065353216u));
        RVar[2u].x = _3355 * max(_3310, uintBitsToFloat(1065353216u));
        ...
        float _3372 = RVar[6u].z;
        RVar[123u].x = _3364;
        RVar[2u].z = _3366 * max(_3338, uintBitsToFloat(1065353216u));
        RVar[2u].w = _3369 * max(clamp(_3325 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        float _3394 = RVar[6u].z;
        ...
        RVar[0u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[8u].z, RVar[8u].z), CBUFFER_4.values[18]);
        float _3431 = RVar[6u].z;
        RVar[1u].x = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[127u].x, uintBitsToFloat(0u)), vec4(CBUFFER_4.values[20].x, CBUFFER_4.values[20].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[1u].y = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[6u].z, _3431 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
        RVar[3u].x = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[23]);
        RVar[3u].y = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[24]);
    }
    PARAM_2 = RVar[2u];
