...
layout(location = 5) in uvec2 aTexCoord1_0_0;
int stackIdxVar;
int stateVar;
vec4 RVar[128];
int stackVar[16];
...
void fs_main()
{
    if (stateVar == 0)
    {
        ...
        RVar[6u] = vec4(vec4(uintBitsToFloat(aTexCoord1_0_0.x), uintBitsToFloat(aTexCoord1_0_0.y), 0.0, 1.0).xy, 0.0, 1.0);
    }
    if (stateVar == 0)
    {
        return;
...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        float _2710 = RVar[21u].w;
        float _2712 = RVar[21u].w;
        RVar[0u].z = dot(RVar[20u], CBUFFER_3.values[5]);
        float _2722 = RVar[21u].z;
        float _2724 = RVar[21u].z;
        float _2726 = (_2722 * _2724) + (_2710 * _2712);
        RVar[0u].w = dot(RVar[20u], CBUFFER_3.values[6]);
        RVar[122u].x = _2726;
        float _2730 = RVar[21u].x;
        float _2732 = RVar[21u].y;
        float _2736 = RVar[21u].x;
        float _2738 = RVar[21u].y;
        ...
        RVar[127u].w = _2753;
        float _2764 = RVar[21u].x;
        RVar[1u].y = CBUFFER_3.values[26].y;
        RVar[4u].x = _2764 * _2753;
        float _2782 = RVar[21u].z;
        float _2784 = RVar[127u].w;
        RVar[4u].y = RVar[21u].y * RVar[127u].w;
        RVar[1u].z = CBUFFER_3.values[26].z;
        RVar[1u].w = clamp(((-dot(_2748, CBUFFER_3.values[2])) + (-CBUFFER_3.values[34].x)) * CBUFFER_3.values[42].x, 0.0, 1.0);
        RVar[4u].z = _2782 * _2784;
    }
    vec4 _2805 = (RVar[0u] * vec4(VS_PUSH.posMulAdd.xy, 1.0, 1.0)) + vec4(VS_PUSH.posMulAdd.zw, 0.0, 0.0);
    vec4 _2808 = _2805;
    _2808.y = -_2805.y;
    vec4 _2816 = _2808;
    _2816.z = (_2808.z + (_2808.w * VS_PUSH.zSpaceMul.x)) * VS_PUSH.zSpaceMul.y;
    gl_Position = _2816;
    PARAM_0 = RVar[1u];
    PARAM_1 = RVar[4u];
    if (stateVar == 0)
    {
        ...
        RVar[2u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[3u].z, RVar[3u].z), CBUFFER_4.values[23]);
        RVar[2u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[3u].z, RVar[3u].z), CBUFFER_4.values[24]);
    }
