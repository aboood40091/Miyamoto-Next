...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[127u].z = _2765;
        RVar[127u].w = _2768;
        RVar[126u].x = (-dot(_2751, CBUFFER_3.values[2])) + (-CBUFFER_3.values[34].x);
        RVar[3u].x = _2759;
        ...
        RVar[3u].y = _2801;
        RVar[3u].z = _2803;
        RVar[1u].w = clamp(_2805 * CBUFFER_3.values[42].x, 0.0, 1.0);
    }
