...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[127u].y = _2862;
        float _2879 = RVar[1u].y;
        float _2883 = RVar[127u].x;
        float _2885 = (_2879 * CBUFFER_3.values[9].y) + _2883;
        RVar[126u].y = (_2862 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        RVar[127u].w = (_2862 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[122u].x = _2885;
        float _2890 = RVar[127u].y;
        float _2895 = (_2890 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2897 = RVar[1u].x;
        float _2901 = (_2897 * CBUFFER_3.values[9].x) + _2885;
        float _2903 = RVar[127u].y;
        float _2908 = (_2903 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        ...
        RVar[127u].x = (_2910 * CBUFFER_3.values[16].y) + RVar[126u].y;
        RVar[126u].y = (_2910 * CBUFFER_3.values[16].x) + _2924;
        RVar[127u].z = (_2910 * CBUFFER_3.values[16].z) + _2908;
        RVar[126u].z = (_2910 * CBUFFER_3.values[16].w) + _2895;
        float _2943 = RVar[1u].x;
        float _2945 = RVar[1u].y;
        float _2947 = RVar[1u].z;
        float _2961 = min(max(-_2901, uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2974 = RVar[126u].y;
        float _2980 = RVar[127u].z;
        float _2986 = RVar[126u].z;
        RVar[127u].x = (_2961 * CBUFFER_3.values[17].y) + RVar[127u].x;
        RVar[127u].z = (_2961 * CBUFFER_3.values[17].x) + _2974;
        RVar[127u].w = (_2961 * CBUFFER_3.values[17].z) + _2980;
        RVar[126u].x = (_2961 * CBUFFER_3.values[17].w) + _2986;
        ...
        float _3022 = RVar[127u].x;
        float _3031 = RVar[127u].w;
        float _3037 = RVar[126u].x;
        RVar[127u].x = (_3012 * CBUFFER_3.values[18].x) + RVar[127u].z;
        RVar[126u].y = (_3012 * CBUFFER_3.values[18].y) + _3022;
        RVar[127u].w = (_3012 * CBUFFER_3.values[18].z) + _3031;
        RVar[126u].w = (_3012 * CBUFFER_3.values[18].w) + _3037;
        ...
        float _3077 = RVar[127u].w;
        float _3083 = RVar[127u].x;
        float _3089 = RVar[126u].w;
        RVar[126u].y = (_3063 * CBUFFER_3.values[19].y) + RVar[126u].y;
        RVar[127u].z = (_3063 * CBUFFER_3.values[19].z) + _3077;
        RVar[127u].w = (_3063 * CBUFFER_3.values[19].x) + _3083;
        RVar[127u].y = (_3063 * CBUFFER_3.values[19].w) + _3089;
        ...
        float _3126 = RVar[127u].w;
        float _3132 = RVar[127u].z;
        float _3141 = RVar[127u].y;
        RVar[2u].x = (_3115 * CBUFFER_3.values[20].y) + RVar[126u].y;
        RVar[2u].y = (_3115 * CBUFFER_3.values[20].x) + _3126;
        RVar[2u].z = (_3115 * CBUFFER_3.values[20].z) + _3132;
        RVar[1u].w = max(-dot(vec4(_3097, _3099, _3101, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[13].x, CBUFFER_3.values[13].y, CBUFFER_3.values[13].z, uintBitsToFloat(0u))), uintBitsToFloat(0u));
        RVar[3u].z = (_3115 * CBUFFER_3.values[20].w) + _3141;
    }
    ...
    if (stateVar == 0)
    {
        ...
        float _3209 = RVar[1u].w;
        float _3211 = min(_3209, uintBitsToFloat(1065353216u));
        float _3225 = RVar[2u].y;
        float _3231 = RVar[2u].z;
        float _3237 = RVar[3u].z;
        RVar[127u].x = (_3211 * CBUFFER_3.values[21].y) + RVar[2u].x;
        RVar[127u].z = (_3211 * CBUFFER_3.values[21].x) + _3225;
        RVar[127u].w = (_3211 * CBUFFER_3.values[21].z) + _3231;
        RVar[126u].x = (_3211 * CBUFFER_3.values[21].w) + _3237;
        ...
        RVar[125u].x = (RVar[4u].z * CBUFFER_4.values[18].z) + RVar[3u].x;
        float _3259 = RVar[127u].z;
        float _3262 = clamp((_3253 * CBUFFER_3.values[22].x) + _3259, 0.0, 1.0);
        float _3266 = RVar[127u].w;
        float _3273 = RVar[127u].x;
        float _3276 = clamp((_3253 * CBUFFER_3.values[22].y) + _3273, 0.0, 1.0);
        float _3280 = RVar[126u].x;
        RVar[123u].x = _3262;
        RVar[127u].y = clamp((_3253 * CBUFFER_3.values[22].z) + _3266, 0.0, 1.0);
        RVar[123u].z = _3276;
        RVar[127u].w = clamp((_3253 * CBUFFER_3.values[22].w) + _3280, 0.0, 1.0);
        float _3295 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3262, 0.0, 1.0);
        float _3302 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3276, 0.0, 1.0);
        RVar[123u].x = _3295;
        RVar[123u].z = _3302;
        float _3312 = RVar[127u].y;
        float _3315 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3312, 0.0, 1.0);
        float _3319 = RVar[127u].w;
        RVar[123u].y = _3315;
        RVar[127u].z = max(_3302, uintBitsToFloat(1065353216u));
        float _3327 = RVar[5u].y;
        float _3331 = RVar[125u].x;
        float _3333 = (_3327 * CBUFFER_4.values[18].y) + _3331;
        RVar[123u].x = _3333;
        RVar[127u].y = max(clamp(_3319 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        RVar[127u].w = max(_3315, uintBitsToFloat(1065353216u));
        RVar[3u].x = max(_3295, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].x;
        float _3352 = RVar[127u].z;
        RVar[6u].y = (RVar[5u].x * CBUFFER_4.values[18].x) + _3333;
        RVar[3u].y = _3352 * CBUFFER_4.values[0].y;
        float _3366 = RVar[127u].y;
        RVar[3u].z = RVar[127u].w * CBUFFER_4.values[0].z;
        RVar[3u].w = CBUFFER_4.values[0].w * _3366;
    }
    PARAM_2 = RVar[3u];
