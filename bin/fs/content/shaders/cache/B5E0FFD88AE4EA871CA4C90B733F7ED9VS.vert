...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[2u].x = max(_3295, uintBitsToFloat(0u)) * CBUFFER_4.values[0].x;
        RVar[123u].z = _3330;
        RVar[2u].y = max(_3288, uintBitsToFloat(0u)) * CBUFFER_4.values[0].y;
        float _3340 = RVar[5u].y;
        float _3344 = (_3340 * CBUFFER_4.values[17].y) + _3330;
        RVar[123u].x = _3344;
        RVar[2u].z = max(_3312, uintBitsToFloat(0u)) * CBUFFER_4.values[0].z;
