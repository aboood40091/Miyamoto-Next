...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[1u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[3u].z, RVar[3u].z), CBUFFER_4.values[20]);
        RVar[1u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[3u].z, RVar[3u].z), CBUFFER_4.values[21]);
