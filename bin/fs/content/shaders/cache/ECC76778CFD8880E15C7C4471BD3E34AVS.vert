...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[19u].x = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[4u].z, RVar[3u].w), CBUFFER_1.values[0]);
        RVar[127u].x = _117 * CBUFFER_1.values[0].z;
        RVar[19u].y = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[4u].z, RVar[3u].w), CBUFFER_1.values[1]);
        RVar[19u].z = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[4u].z, RVar[3u].w), CBUFFER_1.values[2]);
        float _168 = RVar[3u].z;
        RVar[20u].x = dot(vec4(RVar[3u].x, RVar[3u].y, RVar[127u].x, uintBitsToFloat(2147483648u)), vec4(CBUFFER_1.values[0].x, CBUFFER_1.values[0].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        float _188 = RVar[3u].z;
        RVar[20u].y = dot(vec4(RVar[3u].x, RVar[3u].y, _168 * CBUFFER_1.values[1].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_1.values[1].x, CBUFFER_1.values[1].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[20u].z = dot(vec4(RVar[3u].x, RVar[3u].y, _188 * CBUFFER_1.values[2].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_1.values[2].x, CBUFFER_1.values[2].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
    }
    ...
    if (stateVar == 0)
    {
        ...
        RVar[19u].x = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[4u].z, RVar[3u].w), RVar[0u]);
        RVar[127u].x = _305 * _307;
        RVar[19u].y = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[4u].z, RVar[3u].w), RVar[2u]);
        RVar[19u].z = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[4u].z, RVar[3u].w), RVar[1u]);
        float _354 = RVar[3u].z;
        float _356 = RVar[2u].z;
        RVar[20u].x = dot(vec4(RVar[3u].x, RVar[3u].y, RVar[127u].x, uintBitsToFloat(2147483648u)), vec4(RVar[0u].x, RVar[0u].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        float _374 = RVar[3u].z;
        float _376 = RVar[1u].z;
        RVar[20u].y = dot(vec4(RVar[3u].x, RVar[3u].y, _354 * _356, uintBitsToFloat(2147483648u)), vec4(RVar[2u].x, RVar[2u].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[20u].z = dot(vec4(RVar[3u].x, RVar[3u].y, _374 * _376, uintBitsToFloat(2147483648u)), vec4(RVar[1u].x, RVar[1u].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
    }
    if (stackVar[stackIdxVar - 1] == 0)
    {
        stateVar = int(stateVar == 0);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[1u].z = _452;
        RVar[6u].x = intBitsToFloat(floatBitsToInt(_452) + (2));
    ...
    if (stateVar == 0)
    {
        ...
        RVar[127u].y = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[4u].z, RVar[3u].w), RVar[9u]);
        ...
        RVar[125u].x = dot(vec4(RVar[3u].x, RVar[3u].y, RVar[126u].w, uintBitsToFloat(2147483648u)), vec4(RVar[6u].x, RVar[6u].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[126u].w = (_771 * _773) + _731;
        float _779 = RVar[3u].x;
        float _781 = RVar[9u].x;
        ...
        RVar[20u].x = (RVar[2u].y * _785) + RVar[127u].w;
        RVar[123u].y = _799;
        float _809 = RVar[2u].y;
        float _811 = RVar[125u].x;
        float _813 = RVar[126u].y;
        RVar[20u].y = (RVar[2u].y * RVar[126u].w) + _799;
        RVar[20u].z = (_809 * _811) + _813;
    }
    if (stackVar[stackIdxVar - 1] == 0)
    {
        stateVar = int(stateVar == 0);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[6u].z = intBitsToFloat(floatBitsToInt(_861) + (1));
        RVar[6u].x = _876;
        ...
        RVar[1u].z = _893;
        RVar[7u].x = intBitsToFloat(floatBitsToInt(_893) + (2));
    ...
    if (stateVar == 0)
    {
        ...
        vec4 _978 = RVar[8u];
        RVar[6u].x = RVar[3u].z * RVar[8u].z;
        float _999 = RVar[2u].x;
        RVar[1u].y = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[4u].z, RVar[3u].w), RVar[9u]);
    ...
    if (stateVar == 0)
    {
        ...
        float _1042 = RVar[9u].z;
        float _1045 = RVar[1u].x;
        float _1049 = RVar[3u].y;
        float _1051 = RVar[8u].y;
        float _1053 = RVar[6u].x;
        ...
        RVar[127u].z = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[4u].z, RVar[3u].w), RVar[14u]);
        float _1167 = RVar[4u].x;
        float _1169 = RVar[4u].y;
        float _1171 = RVar[4u].z;
        float _1173 = RVar[3u].w;
        vec4 _1176 = RVar[7u];
        RVar[19u].x = RVar[127u].y + (_1163 * dot(vec4(_1135, _1137, _1139, _1141), _1144));
        ...
        float _1236 = RVar[10u].z;
        float _1238 = (_1234 * _1236) + (_1207 * _1209);
        RVar[123u].x = _1220;
        RVar[19u].y = _1222 + (_1191 * _1193);
        RVar[19u].z = _1225 + (_1196 * dot(vec4(_1167, _1169, _1171, _1173), _1176));
        RVar[123u].w = _1232;
        RVar[122u].x = _1238;
        float _1245 = RVar[3u].x;
        float _1247 = RVar[10u].x;
        ...
        float _1322 = RVar[13u].z;
        float _1330 = RVar[2u].y;
        float _1332 = RVar[127u].z;
        float _1336 = RVar[3u].y;
        float _1338 = RVar[14u].y;
        RVar[126u].y = RVar[3u].x * RVar[7u].x;
        ...
        float _1359 = RVar[14u].z;
        float _1361 = (_1357 * _1359) + (_1336 * _1338);
        RVar[127u].y = dot(vec4(RVar[3u].x, RVar[3u].y, _1320 * _1322, uintBitsToFloat(2147483648u)), vec4(RVar[13u].x, RVar[13u].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[122u].x = _1361;
        float _1365 = RVar[3u].y;
        float _1367 = RVar[7u].y;
        float _1369 = RVar[126u].y;
        float _1371 = (_1365 * _1367) + _1369;
        float _1373 = RVar[3u].x;
        float _1375 = RVar[14u].x;
        float _1377 = (_1373 * _1375) + _1361;
        RVar[123u].x = _1371;
        RVar[123u].w = _1377;
        float _1381 = RVar[3u].z;
        float _1383 = RVar[7u].z;
        ...
        RVar[123u].x = _1385;
        RVar[20u].y = (_1387 * _1377) + _1389;
        RVar[20u].x = (_1393 * _1395) + _1397;
        RVar[20u].z = (RVar[2u].z * _1385) + RVar[127u].w;
    }
    if (stackVar[stackIdxVar - 1] == 0)
    {
        stateVar = int(stateVar == 0);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[6u].x = intBitsToFloat(floatBitsToInt(_1454) + (1));
        RVar[0u].y = intBitsToFloat(floatBitsToInt(_1454) + (2));
        RVar[0u].z = _1469;
        float _1482 = RVar[1u].z;
        float _1486 = intBitsToFloat(floatBitsToInt(_1482) * (3));
        RVar[7u].x = intBitsToFloat(floatBitsToInt(_1469) + (2));
        RVar[6u].z = intBitsToFloat(floatBitsToInt(_1469) + (1));
        RVar[8u].x = _1486;
    ...
    if (stateVar == 0)
    {
        ...
        float _1573 = RVar[11u].y;
        float _1576 = RVar[3u].y;
        float _1578 = RVar[10u].y;
        float _1581 = RVar[1u].z;
        float _1587 = RVar[3u].z;
        float _1589 = RVar[9u].z;
        RVar[1u].x = intBitsToFloat(floatBitsToInt(RVar[1u].z) + (2));
        RVar[0u].y = _1571 * _1573;
        RVar[6u].z = _1576 * _1578;
        RVar[1u].w = intBitsToFloat(floatBitsToInt(_1581) + (1));
        float _1608 = RVar[3u].y;
        float _1610 = RVar[9u].y;
        RVar[0u].w = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[4u].z, RVar[3u].w), RVar[9u]);
        RVar[8u].x = (_1608 * _1610) + (_1587 * _1589);
    }
    if (stateVar == 0)
    {
    ...
    if (stateVar == 0)
    {
        ...
        float _1694 = RVar[13u].y;
        float _1697 = RVar[3u].z;
        float _1699 = RVar[11u].z;
        ...
        RVar[127u].y = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[4u].z, RVar[3u].w), RVar[13u]);
        RVar[0u].y = (_1689 * dot(vec4(_1668, _1670, _1672, _1674), _1677)) + uintBitsToFloat(0u);
        float _1737 = RVar[3u].z;
        float _1739 = RVar[12u].z;
        RVar[126u].y = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[4u].z, RVar[3u].w), RVar[12u]);
        RVar[125u].x = _1737 * _1739;
        float _1756 = RVar[3u].z;
        float _1758 = RVar[7u].z;
        RVar[125u].y = dot(vec4(RVar[4u].x, RVar[4u].y, RVar[4u].z, RVar[3u].w), RVar[7u]);
        ...
        float _1880 = RVar[11u].x;
        float _1882 = RVar[126u].x;
        float _1886 = RVar[3u].y;
        float _1888 = RVar[15u].y;
        ...
        RVar[123u].w = _2087;
        RVar[14u].x = (_2089 * _2091) + _2093;
        float _2102 = RVar[3u].x;
        float _2104 = RVar[3u].z;
        float _2106 = RVar[11u].x;
        float _2110 = RVar[15u].x;
        float _2112 = RVar[15u].z;
        ...
        float _2156 = RVar[16u].x;
        float _2158 = RVar[127u].x;
        float _2160 = (_2154 * _2156) + _2158;
        RVar[20u].x = (RVar[2u].w * RVar[126u].z) + _2127;
        RVar[123u].z = _2160;
        float _2164 = RVar[3u].x;
        float _2166 = RVar[17u].x;
        ...
        float _2200 = RVar[14u].x;
        float _2202 = (_2196 * _2198) + _2200;
        float _2204 = RVar[2u].w;
        float _2206 = RVar[124u].y;
        RVar[123u].x = _2202;
        RVar[20u].y = (_2204 * _2186) + _2206;
        RVar[20u].z = (RVar[2u].w * _2202) + RVar[126u].w;
    }
    if (stackVar[stackIdxVar - 1] == 0)
    {
        stateVar = int(stateVar == 0);
    ...
    do
    {
        ...
        if (stateVar == 0)
        {
            RVar[0u].z = intBitsToFloat((floatBitsToInt(CBUFFER_1.values[3].x) > floatBitsToInt(RVar[9u].x)) ? (-1) : 0);
        ...
        if (stateVar == 0)
        {
            ...
            float _2559 = RVar[19u].z;
            float _2562 = RVar[3u].y;
            float _2564 = RVar[7u].y;
    ...
    if (stateVar == 0)
    {
        ...
        RVar[6u].x = uintBitsToFloat(1065353216u);
        RVar[0u].z = dot(RVar[19u], CBUFFER_3.values[5]);
        RVar[6u].w = uintBitsToFloat(0u);
        float _2719 = RVar[20u].w;
        float _2721 = RVar[20u].w;
        RVar[0u].w = dot(RVar[19u], CBUFFER_3.values[6]);
        float _2725 = RVar[20u].x;
        float _2727 = RVar[20u].y;
        float _2729 = RVar[20u].z;
        float _2732 = RVar[20u].x;
        float _2734 = RVar[20u].y;
        float _2736 = RVar[20u].z;
        float _2766 = inversesqrt(dot(vec4(_2725, _2727, _2729, _2719 * _2721), vec4(_2732, _2734, _2736, uintBitsToFloat(1065353216u))));
        RVar[7u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[3u].z, RVar[3u].z * CBUFFER_4.values[17].w), vec4(CBUFFER_4.values[17].x, CBUFFER_4.values[17].y, CBUFFER_4.values[17].z, uintBitsToFloat(1065353216u)));
        float _2769 = RVar[20u].x;
        float _2770 = _2769 * _2766;
        float _2772 = RVar[20u].y;
        float _2773 = _2772 * _2766;
        float _2775 = RVar[20u].z;
        float _2776 = _2775 * _2766;
        float _2778 = RVar[20u].w;
        float _2779 = _2778 * _2766;
        float _2781 = RVar[3u].z;
        RVar[127u].x = _2770;
        RVar[127u].y = _2773;
        RVar[127u].z = _2776;
        RVar[127u].w = _2779;
        RVar[4u].x = _2781 * CBUFFER_4.values[18].w;
        RVar[1u].x = dot(vec4(_2770, _2773, _2776, _2779), CBUFFER_3.values[0]);
        RVar[8u].x = _2770;
        float _2803 = RVar[127u].y;
        RVar[1u].y = dot(RVar[127u], CBUFFER_3.values[1]);
        RVar[8u].y = _2803;
        vec4 _2807 = RVar[127u];
        float _2810 = dot(_2807, CBUFFER_3.values[2]);
        float _2812 = RVar[127u].z;
        RVar[1u].z = _2810;
        RVar[8u].z = _2812;
        float _2816 = RVar[1u].x;
        float _2818 = RVar[1u].y;
        float _2841 = RVar[1u].z;
        RVar[127u].y = RVar[1u].z * CBUFFER_3.values[9].z;
        float _2848 = RVar[1u].x;
        float _2850 = RVar[1u].y;
        float _2862 = min(max(-dot(vec4(_2816, _2818, _2810, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[7].x, CBUFFER_3.values[7].y, CBUFFER_3.values[7].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        RVar[127u].w = _2862;
        float _2865 = RVar[1u].y;
        float _2869 = RVar[127u].y;
        float _2871 = (_2865 * CBUFFER_3.values[9].y) + _2869;
        RVar[123u].x = _2871;
        RVar[127u].y = (_2862 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[126u].w = (_2862 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        float _2890 = RVar[127u].w;
        float _2895 = (_2890 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        float _2897 = RVar[127u].w;
        float _2902 = (_2897 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2904 = min(max(-dot(vec4(_2848, _2850, _2841 * CBUFFER_3.values[8].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[8].x, CBUFFER_3.values[8].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2906 = RVar[1u].x;
        float _2910 = (_2906 * CBUFFER_3.values[9].x) + _2871;
        RVar[123u].x = _2895;
        RVar[123u].y = _2902;
        RVar[123u].w = _2910;
        float _2931 = RVar[127u].y;
        RVar[127u].x = (_2904 * CBUFFER_3.values[16].y) + RVar[126u].w;
        RVar[127u].z = (_2904 * CBUFFER_3.values[16].z) + _2895;
        RVar[126u].w = (_2904 * CBUFFER_3.values[16].x) + _2931;
        RVar[126u].x = (_2904 * CBUFFER_3.values[16].w) + _2902;
        float _2943 = RVar[1u].x;
        float _2945 = RVar[1u].y;
        float _2947 = RVar[1u].z;
        float _2961 = min(max(-_2910, uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2971 = RVar[127u].x;
        float _2977 = RVar[127u].z;
        float _2986 = RVar[126u].x;
        RVar[127u].x = (_2961 * CBUFFER_3.values[17].x) + RVar[126u].w;
        RVar[127u].y = (_2961 * CBUFFER_3.values[17].y) + _2971;
        RVar[127u].z = (_2961 * CBUFFER_3.values[17].z) + _2977;
        RVar[126u].z = (_2961 * CBUFFER_3.values[17].w) + _2986;
        float _2994 = RVar[1u].x;
        float _2996 = RVar[1u].y;
        float _2998 = RVar[1u].z;
        float _3012 = min(max(-dot(vec4(_2943, _2945, _2947, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[10].x, CBUFFER_3.values[10].y, CBUFFER_3.values[10].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3025 = RVar[127u].x;
        float _3031 = RVar[127u].z;
        float _3037 = RVar[126u].z;
        RVar[127u].y = (_3012 * CBUFFER_3.values[18].y) + RVar[127u].y;
        RVar[127u].z = (_3012 * CBUFFER_3.values[18].x) + _3025;
        RVar[126u].w = (_3012 * CBUFFER_3.values[18].z) + _3031;
        RVar[126u].y = (_3012 * CBUFFER_3.values[18].w) + _3037;
        float _3045 = RVar[1u].x;
        float _3047 = RVar[1u].y;
        float _3049 = RVar[1u].z;
        float _3063 = min(max(-dot(vec4(_2994, _2996, _2998, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[11].x, CBUFFER_3.values[11].y, CBUFFER_3.values[11].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3074 = RVar[127u].z;
        float _3083 = RVar[126u].w;
        float _3089 = RVar[126u].y;
        RVar[127u].x = (_3063 * CBUFFER_3.values[19].y) + RVar[127u].y;
        RVar[127u].y = (_3063 * CBUFFER_3.values[19].x) + _3074;
        RVar[126u].w = (_3063 * CBUFFER_3.values[19].z) + _3083;
        RVar[127u].w = (_3063 * CBUFFER_3.values[19].w) + _3089;
        float _3097 = RVar[1u].x;
        float _3099 = RVar[1u].y;
        float _3101 = RVar[1u].z;
        float _3115 = min(max(-dot(vec4(_3045, _3047, _3049, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[12].x, CBUFFER_3.values[12].y, CBUFFER_3.values[12].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3129 = RVar[126u].w;
        float _3135 = RVar[127u].y;
        float _3141 = RVar[127u].w;
        RVar[2u].x = (_3115 * CBUFFER_3.values[20].y) + RVar[127u].x;
        RVar[2u].y = max(-dot(vec4(_3097, _3099, _3101, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[13].x, CBUFFER_3.values[13].y, CBUFFER_3.values[13].z, uintBitsToFloat(0u))), uintBitsToFloat(0u));
        RVar[2u].z = (_3115 * CBUFFER_3.values[20].z) + _3129;
        RVar[1u].w = (_3115 * CBUFFER_3.values[20].x) + _3135;
        RVar[3u].x = (_3115 * CBUFFER_3.values[20].w) + _3141;
    }
    vec4 _3165 = (RVar[0u] * vec4(VS_PUSH.posMulAdd.xy, 1.0, 1.0)) + vec4(VS_PUSH.posMulAdd.zw, 0.0, 0.0);
    vec4 _3168 = _3165;
    _3168.y = -_3165.y;
    vec4 _3176 = _3168;
    _3176.z = (_3168.z + (_3168.w * VS_PUSH.zSpaceMul.x)) * VS_PUSH.zSpaceMul.y;
    gl_Position = _3176;
    PARAM_0 = RVar[8u];
    PARAM_1 = vec4(RVar[6u].x, RVar[6u].x, RVar[6u].x, RVar[6u].w);
    if (stateVar == 0)
    {
        float _3191 = RVar[1u].x;
        float _3193 = RVar[1u].y;
        float _3195 = RVar[1u].z;
        float _3209 = RVar[2u].y;
        float _3211 = min(_3209, uintBitsToFloat(1065353216u));
        float _3222 = RVar[2u].x;
        float _3228 = RVar[2u].z;
        float _3237 = RVar[3u].x;
        RVar[127u].x = (_3211 * CBUFFER_3.values[21].x) + RVar[1u].w;
        RVar[127u].y = (_3211 * CBUFFER_3.values[21].y) + _3222;
        RVar[127u].z = (_3211 * CBUFFER_3.values[21].z) + _3228;
        RVar[126u].z = (_3211 * CBUFFER_3.values[21].w) + _3237;
        float _3253 = min(max(-dot(vec4(_3191, _3193, _3195, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[14].x, CBUFFER_3.values[14].y, CBUFFER_3.values[14].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3255 = RVar[3u].z;
        RVar[126u].x = (RVar[3u].z * CBUFFER_4.values[18].z) + RVar[4u].x;
        RVar[125u].x = _3255 * CBUFFER_4.values[20].w;
        float _3265 = RVar[127u].y;
        float _3268 = clamp((_3253 * CBUFFER_3.values[22].y) + _3265, 0.0, 1.0);
        float _3272 = RVar[126u].z;
        float _3279 = RVar[127u].x;
        float _3282 = clamp((_3253 * CBUFFER_3.values[22].x) + _3279, 0.0, 1.0);
        float _3286 = RVar[127u].z;
        RVar[123u].x = _3268;
        RVar[127u].y = clamp((_3253 * CBUFFER_3.values[22].w) + _3272, 0.0, 1.0);
        RVar[123u].z = _3282;
        RVar[127u].w = clamp((_3253 * CBUFFER_3.values[22].z) + _3286, 0.0, 1.0);
        float _3301 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3268, 0.0, 1.0);
        float _3308 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3282, 0.0, 1.0);
        RVar[123u].x = _3301;
        RVar[123u].z = _3308;
        float _3314 = RVar[127u].y;
        float _3326 = RVar[127u].w;
        float _3329 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3326, 0.0, 1.0);
        RVar[123u].w = _3329;
        float _3342 = RVar[5u].y;
        float _3346 = RVar[126u].x;
        float _3348 = (_3342 * CBUFFER_4.values[18].y) + _3346;
        RVar[4u].x = max(_3308, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].x;
        RVar[4u].y = max(_3301, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].y;
        RVar[122u].x = _3348;
        RVar[7u].y = (RVar[5u].x * CBUFFER_4.values[18].x) + _3348;
        RVar[4u].z = max(_3329, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].z;
        RVar[4u].w = CBUFFER_4.values[0].w * max(clamp(_3314 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        RVar[0u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[3u].z, RVar[125u].x), vec4(CBUFFER_4.values[20].x, CBUFFER_4.values[20].y, CBUFFER_4.values[20].z, uintBitsToFloat(1065353216u)));
        RVar[0u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[3u].z, RVar[3u].z), CBUFFER_4.values[21]);
        RVar[1u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[3u].z, RVar[3u].z), CBUFFER_4.values[23]);
        RVar[1u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[3u].z, RVar[3u].z), CBUFFER_4.values[24]);
        RVar[2u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[3u].z, RVar[3u].z), CBUFFER_4.values[26]);
        RVar[2u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[3u].z, RVar[3u].z), CBUFFER_4.values[27]);
    }
    PARAM_2 = RVar[4u];
    ...
    PARAM_6 = vec4(RVar[2u].x, RVar[2u].y, RVar[2u].z, RVar[2u].z);
    if (stateVar == 0)
    {
    }
}
