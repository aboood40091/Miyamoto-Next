...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[1u].w = _3369 * max(clamp(_3336 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        ...
        RVar[127u].x = (_3394 * CBUFFER_4.values[23].z) + (_3372 * CBUFFER_4.values[23].w);
        RVar[0u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[8u].z, RVar[8u].z), CBUFFER_4.values[18]);
        float _3431 = RVar[6u].z;
        RVar[2u].x = dot(vec4(RVar[8u].x, RVar[2u].y, RVar[127u].x, uintBitsToFloat(0u)), vec4(CBUFFER_4.values[23].x, CBUFFER_4.values[23].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[2u].y = dot(vec4(RVar[8u].x, RVar[2u].y, RVar[6u].z, _3431 * CBUFFER_4.values[24].w), vec4(CBUFFER_4.values[24].x, CBUFFER_4.values[24].y, CBUFFER_4.values[24].z, uintBitsToFloat(1065353216u)));
    }
    PARAM_2 = RVar[1u];
