...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[126u].x = (_2855 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        RVar[127u].z = (_2855 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[127u].w = (_2855 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        RVar[126u].w = (_2855 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2885 = RVar[2u].x;
        float _2887 = RVar[2u].y;
        float _2889 = RVar[2u].z;
        float _2903 = min(max(-dot(vec4(_2841, _2843, _2834 * CBUFFER_3.values[8].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[8].x, CBUFFER_3.values[8].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2914 = RVar[127u].w;
        float _2923 = RVar[127u].z;
        float _2929 = RVar[126u].w;
        RVar[126u].x = (_2903 * CBUFFER_3.values[16].y) + RVar[126u].x;
        RVar[127u].y = (_2903 * CBUFFER_3.values[16].z) + _2914;
        RVar[127u].w = (_2903 * CBUFFER_3.values[16].x) + _2923;
        RVar[127u].x = (_2903 * CBUFFER_3.values[16].w) + _2929;
        ...
        float _2966 = RVar[126u].x;
        float _2972 = RVar[127u].y;
        float _2981 = RVar[127u].x;
        RVar[127u].x = (_2955 * CBUFFER_3.values[17].x) + RVar[127u].w;
        RVar[127u].y = (_2955 * CBUFFER_3.values[17].y) + _2966;
        RVar[127u].z = (_2955 * CBUFFER_3.values[17].z) + _2972;
        RVar[126u].y = (_2955 * CBUFFER_3.values[17].w) + _2981;
        ...
        float _3021 = RVar[127u].y;
        float _3027 = RVar[127u].z;
        float _3033 = RVar[126u].y;
        RVar[127u].y = (_3007 * CBUFFER_3.values[18].x) + RVar[127u].x;
        RVar[127u].z = (_3007 * CBUFFER_3.values[18].y) + _3021;
        RVar[127u].w = (_3007 * CBUFFER_3.values[18].z) + _3027;
        RVar[126u].z = (_3007 * CBUFFER_3.values[18].w) + _3033;
        ...
        float _3073 = RVar[127u].y;
        float _3079 = RVar[127u].w;
        float _3085 = RVar[126u].z;
        RVar[127u].x = (_3059 * CBUFFER_3.values[19].y) + RVar[127u].z;
        RVar[127u].z = (_3059 * CBUFFER_3.values[19].x) + _3073;
        RVar[127u].w = (_3059 * CBUFFER_3.values[19].z) + _3079;
        RVar[126u].w = (_3059 * CBUFFER_3.values[19].w) + _3085;
        float _3093 = RVar[2u].x;
        float _3095 = RVar[2u].y;
        float _3097 = RVar[2u].z;
        ...
        float _3122 = RVar[127u].w;
        float _3131 = RVar[127u].z;
        float _3137 = RVar[126u].w;
        RVar[4u].x = (_3111 * CBUFFER_3.values[20].y) + RVar[127u].x;
        RVar[4u].y = (_3111 * CBUFFER_3.values[20].z) + _3122;
        RVar[4u].z = max(-dot(vec4(_3093, _3095, _3097, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[13].x, CBUFFER_3.values[13].y, CBUFFER_3.values[13].z, uintBitsToFloat(0u))), uintBitsToFloat(0u));
        RVar[2u].w = (_3111 * CBUFFER_3.values[20].x) + _3131;
        RVar[5u].x = (_3111 * CBUFFER_3.values[20].w) + _3137;
    }
    ...
    if (stateVar == 0)
    {
        ...
        float _3203 = RVar[4u].z;
        float _3205 = min(_3203, uintBitsToFloat(1065353216u));
        float _3216 = RVar[4u].x;
        float _3222 = RVar[4u].y;
        float _3231 = RVar[5u].x;
        RVar[127u].x = (_3205 * CBUFFER_3.values[21].x) + RVar[2u].w;
        RVar[127u].y = (_3205 * CBUFFER_3.values[21].y) + _3216;
        RVar[127u].z = (_3205 * CBUFFER_3.values[21].z) + _3222;
        RVar[126u].y = (_3205 * CBUFFER_3.values[21].w) + _3231;
        float _3247 = min(max(-dot(vec4(_3185, _3187, _3189, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[14].x, CBUFFER_3.values[14].y, CBUFFER_3.values[14].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3249 = RVar[5u].z;
        RVar[126u].x = RVar[5u].z * CBUFFER_4.values[17].w;
        RVar[125u].x = _3249 * CBUFFER_4.values[20].w;
        float _3259 = RVar[127u].y;
        float _3262 = clamp((_3247 * CBUFFER_3.values[22].y) + _3259, 0.0, 1.0);
        float _3266 = RVar[127u].x;
        float _3269 = clamp((_3247 * CBUFFER_3.values[22].x) + _3266, 0.0, 1.0);
        float _3273 = RVar[126u].y;
        float _3280 = RVar[127u].z;
        RVar[123u].x = _3262;
        RVar[123u].y = _3269;
        RVar[127u].z = clamp((_3247 * CBUFFER_3.values[22].w) + _3273, 0.0, 1.0);
        RVar[127u].w = clamp((_3247 * CBUFFER_3.values[22].z) + _3280, 0.0, 1.0);
        float _3295 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3262, 0.0, 1.0);
        float _3302 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3269, 0.0, 1.0);
        RVar[123u].x = _3295;
        RVar[123u].y = _3302;
        float _3310 = RVar[127u].z;
        float _3320 = RVar[127u].w;
        float _3323 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3320, 0.0, 1.0);
        RVar[123u].w = _3323;
        float _3329 = RVar[3u].y;
        float _3336 = RVar[5u].z;
        ...
        float _3356 = RVar[3u].w;
        float _3359 = RVar[5u].z;
        float _3363 = RVar[125u].x;
        float _3365 = (_3359 * CBUFFER_4.values[20].z) + _3363;
        RVar[123u].x = _3351;
        RVar[2u].z = _3353 * max(_3323, uintBitsToFloat(1065353216u));
        RVar[2u].w = _3356 * max(clamp(_3310 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        RVar[122u].x = _3365;
        float _3377 = RVar[6u].y;
        RVar[0u].x = (RVar[6u].x * CBUFFER_4.values[17].x) + _3351;
        RVar[125u].x = (_3377 * CBUFFER_4.values[20].y) + _3365;
        RVar[0u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[18]);
        float _3406 = RVar[5u].z;
        RVar[1u].x = (RVar[6u].x * CBUFFER_4.values[20].x) + RVar[125u].x;
        RVar[1u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, _3406 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
        RVar[3u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[23]);
        RVar[3u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[24]);
    }
    PARAM_2 = RVar[2u];
