...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[8u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[4u].z, RVar[4u].z * CBUFFER_4.values[17].w), vec4(CBUFFER_4.values[17].x, CBUFFER_4.values[17].y, CBUFFER_4.values[17].z, uintBitsToFloat(1065353216u)));
        ...
        float _2782 = RVar[4u].z;
        RVar[127u].x = _2771;
        RVar[127u].y = _2774;
        RVar[127u].z = _2777;
        RVar[127u].w = _2780;
        RVar[5u].x = _2782 * CBUFFER_4.values[18].w;
        ...
        RVar[127u].w = _2863;
        float _2866 = RVar[1u].y;
        float _2870 = RVar[127u].y;
        float _2872 = (_2866 * CBUFFER_3.values[9].y) + _2870;
        RVar[123u].x = _2872;
        RVar[127u].y = (_2863 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[126u].w = (_2863 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        float _2891 = RVar[127u].w;
        float _2896 = (_2891 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        float _2898 = RVar[127u].w;
        float _2903 = (_2898 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2905 = min(max(-dot(vec4(_2849, _2851, _2842 * CBUFFER_3.values[8].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[8].x, CBUFFER_3.values[8].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2907 = RVar[1u].x;
        float _2911 = (_2907 * CBUFFER_3.values[9].x) + _2872;
        RVar[123u].x = _2896;
        RVar[123u].y = _2903;
        RVar[123u].w = _2911;
        float _2932 = RVar[127u].y;
        RVar[127u].x = (_2905 * CBUFFER_3.values[16].y) + RVar[126u].w;
        RVar[127u].z = (_2905 * CBUFFER_3.values[16].z) + _2896;
        RVar[126u].w = (_2905 * CBUFFER_3.values[16].x) + _2932;
        RVar[126u].x = (_2905 * CBUFFER_3.values[16].w) + _2903;
        float _2944 = RVar[1u].x;
        float _2946 = RVar[1u].y;
        float _2948 = RVar[1u].z;
        float _2962 = min(max(-_2911, uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2972 = RVar[127u].x;
        float _2978 = RVar[127u].z;
        float _2987 = RVar[126u].x;
        RVar[127u].x = (_2962 * CBUFFER_3.values[17].x) + RVar[126u].w;
        RVar[127u].y = (_2962 * CBUFFER_3.values[17].y) + _2972;
        RVar[127u].z = (_2962 * CBUFFER_3.values[17].z) + _2978;
        RVar[126u].z = (_2962 * CBUFFER_3.values[17].w) + _2987;
        ...
        float _3026 = RVar[127u].x;
        float _3032 = RVar[127u].z;
        float _3038 = RVar[126u].z;
        RVar[127u].y = (_3013 * CBUFFER_3.values[18].y) + RVar[127u].y;
        RVar[127u].z = (_3013 * CBUFFER_3.values[18].x) + _3026;
        RVar[126u].w = (_3013 * CBUFFER_3.values[18].z) + _3032;
        RVar[126u].y = (_3013 * CBUFFER_3.values[18].w) + _3038;
        ...
        float _3075 = RVar[127u].z;
        float _3084 = RVar[126u].w;
        float _3090 = RVar[126u].y;
        RVar[127u].x = (_3064 * CBUFFER_3.values[19].y) + RVar[127u].y;
        RVar[127u].y = (_3064 * CBUFFER_3.values[19].x) + _3075;
        RVar[126u].w = (_3064 * CBUFFER_3.values[19].z) + _3084;
        RVar[127u].w = (_3064 * CBUFFER_3.values[19].w) + _3090;
        ...
        float _3130 = RVar[126u].w;
        float _3136 = RVar[127u].y;
        float _3142 = RVar[127u].w;
        RVar[2u].x = (_3116 * CBUFFER_3.values[20].y) + RVar[127u].x;
        RVar[2u].y = max(-dot(vec4(_3098, _3100, _3102, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[13].x, CBUFFER_3.values[13].y, CBUFFER_3.values[13].z, uintBitsToFloat(0u))), uintBitsToFloat(0u));
        RVar[2u].z = (_3116 * CBUFFER_3.values[20].z) + _3130;
        RVar[1u].w = (_3116 * CBUFFER_3.values[20].x) + _3136;
        RVar[4u].x = (_3116 * CBUFFER_3.values[20].w) + _3142;
    }
    ...
    if (stateVar == 0)
    {
        ...
        float _3210 = RVar[2u].y;
        float _3212 = min(_3210, uintBitsToFloat(1065353216u));
        float _3223 = RVar[2u].x;
        float _3229 = RVar[2u].z;
        float _3238 = RVar[4u].x;
        RVar[127u].x = (_3212 * CBUFFER_3.values[21].x) + RVar[1u].w;
        RVar[127u].y = (_3212 * CBUFFER_3.values[21].y) + _3223;
        RVar[127u].z = (_3212 * CBUFFER_3.values[21].z) + _3229;
        ...
        float _3256 = RVar[4u].z;
        RVar[126u].x = (RVar[4u].z * CBUFFER_4.values[18].z) + RVar[5u].x;
        RVar[125u].x = _3256 * CBUFFER_4.values[20].w;
        float _3266 = RVar[127u].y;
        float _3269 = clamp((_3254 * CBUFFER_3.values[22].y) + _3266, 0.0, 1.0);
        float _3273 = RVar[126u].z;
        float _3280 = RVar[127u].x;
        float _3283 = clamp((_3254 * CBUFFER_3.values[22].x) + _3280, 0.0, 1.0);
        float _3287 = RVar[127u].z;
        RVar[123u].x = _3269;
        RVar[127u].y = clamp((_3254 * CBUFFER_3.values[22].w) + _3273, 0.0, 1.0);
        RVar[123u].z = _3283;
        RVar[127u].w = clamp((_3254 * CBUFFER_3.values[22].z) + _3287, 0.0, 1.0);
        float _3302 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3269, 0.0, 1.0);
        float _3309 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3283, 0.0, 1.0);
        RVar[123u].x = _3302;
        RVar[123u].z = _3309;
        float _3315 = RVar[127u].y;
        float _3327 = RVar[127u].w;
        float _3330 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3327, 0.0, 1.0);
        RVar[123u].w = _3330;
        float _3336 = RVar[3u].y;
        float _3343 = RVar[6u].y;
        float _3347 = RVar[126u].x;
        float _3349 = (_3343 * CBUFFER_4.values[18].y) + _3347;
        RVar[5u].x = RVar[3u].x * max(_3309, uintBitsToFloat(1065353216u));
        RVar[5u].y = _3336 * max(_3302, uintBitsToFloat(1065353216u));
        RVar[122u].x = _3349;
        float _3354 = RVar[4u].z;
        float _3358 = RVar[125u].x;
        float _3360 = (_3354 * CBUFFER_4.values[20].z) + _3358;
        float _3362 = RVar[6u].x;
        float _3368 = RVar[3u].z;
        float _3371 = RVar[3u].w;
        RVar[123u].x = _3360;
        RVar[8u].y = (_3362 * CBUFFER_4.values[18].x) + _3349;
        RVar[5u].z = _3368 * max(_3330, uintBitsToFloat(1065353216u));
        RVar[5u].w = _3371 * max(clamp(_3315 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        float _3392 = RVar[4u].z;
        RVar[0u].x = dot(vec4(RVar[6u].x, RVar[6u].y, _3360, uintBitsToFloat(0u)), vec4(CBUFFER_4.values[20].x, CBUFFER_4.values[20].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[0u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[4u].z, _3392 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
        RVar[1u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[4u].z, RVar[4u].z), CBUFFER_4.values[23]);
        RVar[1u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[4u].z, RVar[4u].z), CBUFFER_4.values[24]);
        RVar[2u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[4u].z, RVar[4u].z), CBUFFER_4.values[26]);
        RVar[2u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[4u].z, RVar[4u].z), CBUFFER_4.values[27]);
    }
    PARAM_2 = RVar[5u];
