...
void main()
{
    ...
    do
    {
        ...
        if (stateVar == 0)
        {
            ...
            RVar[3u].y = RVar[20u].y + (RVar[9u].x * dot(vec4(_2492, _2494, _2496, _2498), _2501));
    ...
    if (stateVar == 0)
    {
        ...
        float _2759 = RVar[21u].x;
        float _2760 = _2759 * _2757;
        float _2762 = RVar[21u].y;
        float _2763 = _2762 * _2757;
        float _2765 = RVar[21u].z;
        float _2766 = _2765 * _2757;
        float _2768 = RVar[21u].w;
    ...
    if (stateVar == 0)
    {
        ...
        float _3351 = (_3347 * CBUFFER_4.values[17].y) + _3341;
        float _3356 = RVar[3u].w;
        RVar[123u].x = _3351;
        RVar[2u].z = max(_3322, uintBitsToFloat(1065353216u)) * CBUFFER_4.values[0].z;
        RVar[2u].w = _3356 * max(clamp(_3309 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        float _3368 = RVar[4u].z;
        float _3372 = RVar[125u].x;
        RVar[0u].x = (RVar[6u].x * CBUFFER_4.values[17].x) + _3351;
        RVar[125u].x = (_3368 * CBUFFER_4.values[20].z) + _3372;
        RVar[0u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[4u].z, RVar[4u].z), CBUFFER_4.values[18]);
        float _3407 = RVar[4u].z;
        ...
        RVar[1u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[4u].z, _3407 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
        RVar[3u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[4u].z, RVar[4u].z), CBUFFER_4.values[23]);
        RVar[3u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[4u].z, RVar[4u].z), CBUFFER_4.values[24]);
    }
    PARAM_2 = RVar[2u];
