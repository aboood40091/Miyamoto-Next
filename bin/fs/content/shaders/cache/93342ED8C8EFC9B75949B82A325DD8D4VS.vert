...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[127u].z = _2762;
        RVar[127u].w = _2765;
        RVar[126u].x = (-dot(_2748, CBUFFER_3.values[2])) + (-CBUFFER_3.values[33].x);
        RVar[4u].x = _2756;
        ...
        RVar[1u].w = clamp(_2810 * CBUFFER_3.values[41].x, 0.0, 1.0);
    }
    ...
    if (stateVar == 0)
    {
        ...
        RVar[1u].x = dot(vec4(RVar[2u].x, RVar[2u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[20]);
        RVar[1u].y = dot(vec4(RVar[2u].x, RVar[2u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[21]);
        RVar[3u].x = dot(vec4(RVar[2u].x, RVar[2u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[23]);
        RVar[3u].y = dot(vec4(RVar[2u].x, RVar[2u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[24]);
    ...
    PARAM_5 = vec4(RVar[2u].x, RVar[2u].y, RVar[2u].z, RVar[2u].z);
    if (stateVar == 0)
    {
    }
}
