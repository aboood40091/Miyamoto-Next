...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[9u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, RVar[5u].z * CBUFFER_4.values[17].w), vec4(CBUFFER_4.values[17].x, CBUFFER_4.values[17].y, CBUFFER_4.values[17].z, uintBitsToFloat(1065353216u)));
        ...
        RVar[123u].x = _2870;
        RVar[127u].z = (_2861 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[126u].w = (_2861 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        float _2889 = RVar[127u].w;
        float _2894 = (_2889 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        float _2896 = RVar[127u].w;
        float _2901 = (_2896 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2903 = min(max(-dot(vec4(_2847, _2849, _2839 * CBUFFER_3.values[8].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[8].x, CBUFFER_3.values[8].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2905 = RVar[1u].x;
        float _2909 = (_2905 * CBUFFER_3.values[9].x) + _2870;
        RVar[123u].x = _2894;
        RVar[123u].y = _2901;
        RVar[123u].w = _2909;
        float _2930 = RVar[127u].z;
        RVar[127u].x = (_2903 * CBUFFER_3.values[16].y) + RVar[126u].w;
        RVar[127u].y = (_2903 * CBUFFER_3.values[16].z) + _2894;
        RVar[126u].w = (_2903 * CBUFFER_3.values[16].x) + _2930;
        RVar[126u].x = (_2903 * CBUFFER_3.values[16].w) + _2901;
        float _2942 = RVar[1u].x;
        float _2944 = RVar[1u].y;
        float _2946 = RVar[1u].z;
        float _2960 = min(max(-_2909, uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2970 = RVar[127u].x;
        float _2976 = RVar[127u].y;
        float _2985 = RVar[126u].x;
        RVar[127u].x = (_2960 * CBUFFER_3.values[17].x) + RVar[126u].w;
        RVar[127u].y = (_2960 * CBUFFER_3.values[17].y) + _2970;
        RVar[127u].z = (_2960 * CBUFFER_3.values[17].z) + _2976;
        RVar[126u].y = (_2960 * CBUFFER_3.values[17].w) + _2985;
        ...
        float _3030 = RVar[127u].z;
        float _3036 = RVar[126u].y;
        RVar[127u].y = (_3011 * CBUFFER_3.values[18].x) + RVar[127u].x;
        RVar[127u].z = (_3011 * CBUFFER_3.values[18].y) + _3024;
        RVar[126u].w = (_3011 * CBUFFER_3.values[18].z) + _3030;
        RVar[126u].z = (_3011 * CBUFFER_3.values[18].w) + _3036;
        ...
        float _3082 = RVar[126u].w;
        float _3088 = RVar[126u].z;
        RVar[127u].x = (_3062 * CBUFFER_3.values[19].y) + RVar[127u].z;
        RVar[127u].z = (_3062 * CBUFFER_3.values[19].x) + _3076;
        RVar[126u].w = (_3062 * CBUFFER_3.values[19].z) + _3082;
        RVar[127u].w = (_3062 * CBUFFER_3.values[19].w) + _3088;
        ...
        float _3125 = RVar[126u].w;
        float _3134 = RVar[127u].z;
        float _3140 = RVar[127u].w;
        RVar[2u].x = (_3114 * CBUFFER_3.values[20].y) + RVar[127u].x;
        RVar[2u].y = (_3114 * CBUFFER_3.values[20].z) + _3125;
        RVar[2u].z = max(-dot(vec4(_3096, _3098, _3100, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[13].x, CBUFFER_3.values[13].y, CBUFFER_3.values[13].z, uintBitsToFloat(0u))), uintBitsToFloat(0u));
        RVar[1u].w = (_3114 * CBUFFER_3.values[20].x) + _3134;
    ...
    if (stateVar == 0)
    {
        ...
        float _3208 = RVar[2u].z;
        float _3210 = min(_3208, uintBitsToFloat(1065353216u));
        float _3221 = RVar[2u].x;
        float _3227 = RVar[2u].y;
        float _3236 = RVar[4u].x;
        RVar[127u].x = (_3210 * CBUFFER_3.values[21].x) + RVar[1u].w;
        RVar[127u].y = (_3210 * CBUFFER_3.values[21].y) + _3221;
        RVar[127u].z = (_3210 * CBUFFER_3.values[21].z) + _3227;
        RVar[126u].y = (_3210 * CBUFFER_3.values[21].w) + _3236;
        ...
        float _3254 = RVar[4u].z;
        RVar[126u].x = (RVar[5u].z * CBUFFER_4.values[18].z) + RVar[5u].x;
        RVar[125u].x = _3254 * CBUFFER_4.values[20].w;
        float _3264 = RVar[127u].y;
        float _3267 = clamp((_3252 * CBUFFER_3.values[22].y) + _3264, 0.0, 1.0);
        float _3271 = RVar[127u].x;
        float _3274 = clamp((_3252 * CBUFFER_3.values[22].x) + _3271, 0.0, 1.0);
        float _3278 = RVar[126u].y;
        float _3285 = RVar[127u].z;
        RVar[123u].x = _3267;
        RVar[123u].y = _3274;
        RVar[127u].z = clamp((_3252 * CBUFFER_3.values[22].w) + _3278, 0.0, 1.0);
        RVar[127u].w = clamp((_3252 * CBUFFER_3.values[22].z) + _3285, 0.0, 1.0);
        float _3300 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3267, 0.0, 1.0);
        float _3307 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3274, 0.0, 1.0);
        RVar[123u].x = _3300;
        RVar[123u].y = _3307;
        float _3315 = RVar[127u].z;
        float _3325 = RVar[127u].w;
        float _3328 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3325, 0.0, 1.0);
        RVar[123u].w = _3328;
        float _3331 = RVar[6u].y;
        float _3335 = RVar[126u].x;
        float _3337 = (_3331 * CBUFFER_4.values[18].y) + _3335;
        float _3339 = RVar[3u].y;
        float _3346 = RVar[3u].x;
        RVar[123u].x = _3337;
        RVar[5u].y = _3339 * max(_3300, uintBitsToFloat(1065353216u));
        RVar[5u].x = _3346 * max(_3307, uintBitsToFloat(1065353216u));
        float _3358 = RVar[3u].z;
        RVar[9u].y = (RVar[6u].x * CBUFFER_4.values[18].x) + _3337;
        RVar[5u].z = _3358 * max(_3328, uintBitsToFloat(1065353216u));
        RVar[5u].w = max(clamp(_3315 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u)) * CBUFFER_4.values[0].w;
        RVar[0u].x = dot(vec4(RVar[7u].x, RVar[4u].y, RVar[4u].z, RVar[125u].x), vec4(CBUFFER_4.values[20].x, CBUFFER_4.values[20].y, CBUFFER_4.values[20].z, uintBitsToFloat(1065353216u)));
        RVar[0u].y = dot(vec4(RVar[7u].x, RVar[4u].y, RVar[4u].z, RVar[4u].z), CBUFFER_4.values[21]);
        RVar[1u].x = dot(vec4(RVar[7u].x, RVar[4u].y, RVar[4u].z, RVar[4u].z), CBUFFER_4.values[23]);
        RVar[1u].y = dot(vec4(RVar[7u].x, RVar[4u].y, RVar[4u].z, RVar[4u].z), CBUFFER_4.values[24]);
    }
    PARAM_2 = RVar[5u];
