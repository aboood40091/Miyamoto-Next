...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        float _2702 = RVar[21u].w;
        float _2704 = RVar[21u].w;
        RVar[0u].y = dot(RVar[20u], CBUFFER_3.values[4]);
        float _2714 = RVar[21u].z;
        float _2716 = RVar[21u].z;
        float _2718 = (_2714 * _2716) + (_2702 * _2704);
        RVar[0u].z = dot(RVar[20u], CBUFFER_3.values[5]);
        RVar[122u].x = _2718;
        float _2728 = RVar[21u].y;
        float _2730 = RVar[21u].y;
        float _2732 = (_2728 * _2730) + _2718;
        RVar[0u].w = dot(RVar[20u], CBUFFER_3.values[6]);
        RVar[122u].x = _2732;
        float _2743 = RVar[21u].x;
        float _2745 = RVar[21u].x;
        float _2747 = (_2743 * _2745) + _2732;
        RVar[1u].x = CBUFFER_3.values[26].x;
        RVar[1u].y = CBUFFER_3.values[26].y;
        RVar[1u].z = CBUFFER_3.values[26].z;
        RVar[123u].w = _2747;
        vec4 _2753 = RVar[20u];
        float _2758 = inversesqrt(_2747);
        float _2760 = RVar[21u].x;
        float _2761 = _2760 * _2758;
        float _2763 = RVar[21u].y;
        float _2764 = _2763 * _2758;
        float _2766 = RVar[21u].z;
        float _2767 = _2766 * _2758;
        float _2769 = RVar[21u].w;
        float _2770 = _2769 * _2758;
        RVar[127u].x = _2761;
        RVar[127u].y = _2764;
        RVar[127u].z = _2767;
        RVar[127u].w = _2770;
        RVar[126u].x = (-dot(_2753, CBUFFER_3.values[2])) + (-CBUFFER_3.values[34].x);
        RVar[2u].x = dot(vec4(_2761, _2764, _2767, _2770), CBUFFER_3.values[0]);
        RVar[7u].x = _2761;
        float _2794 = RVar[127u].y;
        RVar[2u].y = dot(RVar[127u], CBUFFER_3.values[1]);
        RVar[7u].y = _2794;
        vec4 _2798 = RVar[127u];
        float _2801 = dot(_2798, CBUFFER_3.values[2]);
        float _2803 = RVar[127u].z;
        RVar[2u].z = _2801;
        RVar[7u].z = _2803;
        float _2807 = RVar[2u].x;
        float _2809 = RVar[2u].y;
        float _2823 = RVar[2u].z;
        RVar[1u].w = clamp(RVar[126u].x * CBUFFER_3.values[42].x, 0.0, 1.0);
        float _2841 = RVar[2u].x;
        float _2843 = RVar[2u].y;
        float _2855 = min(max(-dot(vec4(_2807, _2809, _2801, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[7].x, CBUFFER_3.values[7].y, CBUFFER_3.values[7].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        RVar[126u].x = (_2855 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[127u].y = (_2855 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        RVar[127u].z = (_2855 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        RVar[126u].y = (_2855 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2885 = RVar[2u].x;
        float _2887 = RVar[2u].y;
        float _2889 = RVar[2u].z;
        float _2903 = min(max(-dot(vec4(_2841, _2843, _2823 * CBUFFER_3.values[8].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[8].x, CBUFFER_3.values[8].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2917 = RVar[127u].y;
        float _2923 = RVar[127u].z;
        float _2929 = RVar[126u].y;
        RVar[127u].y = (_2903 * CBUFFER_3.values[16].x) + RVar[126u].x;
        RVar[127u].z = (_2903 * CBUFFER_3.values[16].y) + _2917;
        RVar[127u].w = (_2903 * CBUFFER_3.values[16].z) + _2923;
        RVar[126u].z = (_2903 * CBUFFER_3.values[16].w) + _2929;
        float _2937 = RVar[2u].x;
        float _2939 = RVar[2u].y;
        float _2941 = RVar[2u].z;
        float _2955 = min(max(-dot(vec4(_2885, _2887, _2889, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[9].x, CBUFFER_3.values[9].y, CBUFFER_3.values[9].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _2969 = RVar[127u].y;
        float _2975 = RVar[127u].w;
        float _2981 = RVar[126u].z;
        RVar[126u].x = (_2955 * CBUFFER_3.values[17].y) + RVar[127u].z;
        RVar[127u].z = (_2955 * CBUFFER_3.values[17].x) + _2969;
        RVar[127u].w = (_2955 * CBUFFER_3.values[17].z) + _2975;
        RVar[126u].w = (_2955 * CBUFFER_3.values[17].w) + _2981;
        float _2989 = RVar[2u].x;
        float _2991 = RVar[2u].y;
        float _2993 = RVar[2u].z;
        float _3007 = min(max(-dot(vec4(_2937, _2939, _2941, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[10].x, CBUFFER_3.values[10].y, CBUFFER_3.values[10].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3018 = RVar[127u].w;
        float _3027 = RVar[127u].z;
        float _3033 = RVar[126u].w;
        RVar[126u].x = (_3007 * CBUFFER_3.values[18].y) + RVar[126u].x;
        RVar[127u].y = (_3007 * CBUFFER_3.values[18].z) + _3018;
        RVar[127u].w = (_3007 * CBUFFER_3.values[18].x) + _3027;
        RVar[127u].x = (_3007 * CBUFFER_3.values[18].w) + _3033;
        float _3041 = RVar[2u].x;
        float _3043 = RVar[2u].y;
        float _3045 = RVar[2u].z;
        float _3059 = min(max(-dot(vec4(_2989, _2991, _2993, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[11].x, CBUFFER_3.values[11].y, CBUFFER_3.values[11].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3070 = RVar[126u].x;
        float _3076 = RVar[127u].y;
        float _3085 = RVar[127u].x;
        RVar[127u].x = (_3059 * CBUFFER_3.values[19].x) + RVar[127u].w;
        RVar[127u].y = (_3059 * CBUFFER_3.values[19].y) + _3070;
        RVar[127u].z = (_3059 * CBUFFER_3.values[19].z) + _3076;
        RVar[126u].y = (_3059 * CBUFFER_3.values[19].w) + _3085;
        float _3111 = min(max(-dot(vec4(_3041, _3043, _3045, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[12].x, CBUFFER_3.values[12].y, CBUFFER_3.values[12].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3119 = RVar[127u].x;
        float _3125 = RVar[127u].y;
        float _3131 = RVar[127u].z;
        float _3137 = RVar[126u].y;
        RVar[4u].x = max(-dot(vec4(RVar[2u].x, RVar[2u].y, RVar[2u].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[13].x, CBUFFER_3.values[13].y, CBUFFER_3.values[13].z, uintBitsToFloat(0u))), uintBitsToFloat(0u));
        RVar[4u].y = (_3111 * CBUFFER_3.values[20].x) + _3119;
        RVar[4u].z = (_3111 * CBUFFER_3.values[20].y) + _3125;
        RVar[2u].w = (_3111 * CBUFFER_3.values[20].z) + _3131;
        RVar[5u].z = (_3111 * CBUFFER_3.values[20].w) + _3137;
    }
    vec4 _3160 = (RVar[0u] * vec4(VS_PUSH.posMulAdd.xy, 1.0, 1.0)) + vec4(VS_PUSH.posMulAdd.zw, 0.0, 0.0);
    vec4 _3163 = _3160;
    _3163.y = -_3160.y;
    vec4 _3171 = _3163;
    _3171.z = (_3163.z + (_3163.w * VS_PUSH.zSpaceMul.x)) * VS_PUSH.zSpaceMul.y;
    gl_Position = _3171;
    PARAM_0 = RVar[1u];
    PARAM_1 = RVar[7u];
    if (stateVar == 0)
    {
        float _3185 = RVar[2u].x;
        float _3187 = RVar[2u].y;
        float _3189 = RVar[2u].z;
        float _3203 = RVar[4u].x;
        float _3205 = min(_3203, uintBitsToFloat(1065353216u));
        float _3219 = RVar[4u].y;
        float _3225 = RVar[2u].w;
        float _3231 = RVar[5u].z;
        RVar[127u].x = (_3205 * CBUFFER_3.values[21].y) + RVar[4u].z;
        RVar[127u].z = (_3205 * CBUFFER_3.values[21].x) + _3219;
        RVar[127u].w = (_3205 * CBUFFER_3.values[21].z) + _3225;
        RVar[126u].w = (_3205 * CBUFFER_3.values[21].w) + _3231;
        float _3239 = min(max(-dot(vec4(_3185, _3187, _3189, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[14].x, CBUFFER_3.values[14].y, CBUFFER_3.values[14].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3249 = RVar[6u].z;
        RVar[126u].y = RVar[6u].z * CBUFFER_4.values[20].w;
        RVar[126u].x = _3249 * CBUFFER_4.values[17].w;
        float _3266 = RVar[127u].w;
        float _3273 = RVar[127u].x;
        float _3276 = clamp((_3239 * CBUFFER_3.values[22].y) + _3273, 0.0, 1.0);
        float _3280 = RVar[127u].z;
        float _3283 = clamp((_3239 * CBUFFER_3.values[22].x) + _3280, 0.0, 1.0);
        RVar[127u].x = clamp((_3239 * CBUFFER_3.values[22].w) + RVar[126u].w, 0.0, 1.0);
        RVar[127u].y = clamp((_3239 * CBUFFER_3.values[22].z) + _3266, 0.0, 1.0);
        RVar[123u].z = _3276;
        RVar[123u].w = _3283;
        float _3295 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3276, 0.0, 1.0);
        float _3302 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3283, 0.0, 1.0);
        RVar[123u].z = _3295;
        RVar[123u].w = _3302;
        float _3312 = RVar[127u].y;
        float _3315 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3312, 0.0, 1.0);
        float _3319 = RVar[127u].x;
        RVar[123u].y = _3315;
        float _3329 = RVar[3u].y;
        float _3336 = RVar[6u].z;
        float _3340 = RVar[126u].x;
        float _3342 = (_3336 * CBUFFER_4.values[17].z) + _3340;
        RVar[2u].x = RVar[3u].x * max(_3302, uintBitsToFloat(1065353216u));
        RVar[2u].y = _3329 * max(_3295, uintBitsToFloat(1065353216u));
        RVar[122u].x = _3342;
        float _3347 = RVar[6u].y;
        float _3351 = (_3347 * CBUFFER_4.values[17].y) + _3342;
        float _3353 = RVar[3u].z;
        RVar[123u].x = _3351;
        RVar[2u].z = _3353 * max(_3315, uintBitsToFloat(1065353216u));
        RVar[2u].w = max(clamp(_3319 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u)) * CBUFFER_4.values[0].w;
        float _3368 = RVar[6u].z;
        float _3372 = RVar[126u].y;
        RVar[0u].x = (RVar[6u].x * CBUFFER_4.values[17].x) + _3351;
        RVar[126u].x = (_3368 * CBUFFER_4.values[20].z) + _3372;
        RVar[0u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[18]);
        float _3407 = RVar[6u].z;
        RVar[1u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[126u].x, uintBitsToFloat(0u)), vec4(CBUFFER_4.values[20].x, CBUFFER_4.values[20].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[1u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[6u].z, _3407 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
        RVar[3u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[23]);
        RVar[3u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[24]);
        RVar[4u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[26]);
        RVar[4u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[27]);
    }
    PARAM_2 = RVar[2u];
