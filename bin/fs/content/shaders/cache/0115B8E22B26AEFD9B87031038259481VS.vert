...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        float _2768 = RVar[20u].z;
        float _2771 = RVar[20u].x;
        RVar[3u].y = RVar[20u].y * _2757;
        RVar[3u].z = _2768 * _2757;
        RVar[3u].x = _2771 * _2757;
        RVar[1u].w = clamp(((-dot(_2752, CBUFFER_3.values[2])) + (-CBUFFER_3.values[34].x)) * CBUFFER_3.values[42].x, 0.0, 1.0);
    }
    vec4 _2798 = (RVar[0u] * vec4(VS_PUSH.posMulAdd.xy, 1.0, 1.0)) + vec4(VS_PUSH.posMulAdd.zw, 0.0, 0.0);
    vec4 _2801 = _2798;
    _2801.y = -_2798.y;
    vec4 _2809 = _2801;
    _2809.z = (_2801.z + (_2801.w * VS_PUSH.zSpaceMul.x)) * VS_PUSH.zSpaceMul.y;
    gl_Position = _2809;
    PARAM_0 = RVar[1u];
    PARAM_1 = RVar[3u];
    if (stateVar == 0)
    {
        RVar[0u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[17]);
        RVar[0u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[18]);
        RVar[1u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[20]);
        RVar[1u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[21]);
        RVar[2u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[23]);
        RVar[2u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[24]);
        RVar[3u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[26]);
        RVar[3u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[27]);
    }
