...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[2u].w = max(clamp(_3330 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u)) * CBUFFER_4.values[0].w;
        float _3379 = RVar[6u].z;
        float _3383 = RVar[126u].y;
        RVar[0u].x = (RVar[5u].x * CBUFFER_4.values[17].x) + _3362;
        RVar[126u].x = (_3379 * CBUFFER_4.values[20].z) + _3383;
        RVar[0u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[6u].z, RVar[6u].z), CBUFFER_4.values[18]);
        float _3418 = RVar[6u].z;
        ...
        RVar[1u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[6u].z, _3418 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
