...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[1u].z = _2800;
        RVar[8u].y = ((-_2788) * uintBitsToFloat(1056964608u)) + uintBitsToFloat(1056964608u);
        float _2809 = RVar[2u].x;
        float _2811 = RVar[5u].y;
        ...
        float _2842 = RVar[5u].y;
        float _2844 = RVar[1u].z;
        ...
        RVar[127u].x = (_2858 * CBUFFER_3.values[15].x) + uintBitsToFloat(0u);
        RVar[127u].y = (_2858 * CBUFFER_3.values[15].y) + uintBitsToFloat(0u);
        RVar[127u].w = (_2858 * CBUFFER_3.values[15].z) + uintBitsToFloat(0u);
        RVar[126u].y = (_2858 * CBUFFER_3.values[15].w) + uintBitsToFloat(0u);
        float _2888 = RVar[2u].x;
        float _2890 = RVar[5u].y;
        float _2892 = RVar[1u].z;
        ...
        float _2920 = RVar[127u].y;
        float _2926 = RVar[127u].w;
        float _2932 = RVar[126u].y;
        RVar[127u].y = (_2906 * CBUFFER_3.values[16].x) + RVar[127u].x;
        RVar[127u].z = (_2906 * CBUFFER_3.values[16].y) + _2920;
        RVar[127u].w = (_2906 * CBUFFER_3.values[16].z) + _2926;
        RVar[126u].w = (_2906 * CBUFFER_3.values[16].w) + _2932;
        float _2940 = RVar[2u].x;
        float _2942 = RVar[5u].y;
        float _2944 = RVar[1u].z;
        ...
        float _2972 = RVar[127u].w;
        float _2978 = RVar[127u].y;
        float _2984 = RVar[126u].w;
        RVar[127u].x = (_2958 * CBUFFER_3.values[17].y) + RVar[127u].z;
        RVar[127u].z = (_2958 * CBUFFER_3.values[17].z) + _2972;
        RVar[127u].w = (_2958 * CBUFFER_3.values[17].x) + _2978;
        RVar[126u].z = (_2958 * CBUFFER_3.values[17].w) + _2984;
        float _2992 = RVar[2u].x;
        float _2994 = RVar[5u].y;
        float _2996 = RVar[1u].z;
        ...
        float _3021 = RVar[127u].z;
        float _3027 = RVar[127u].w;
        float _3036 = RVar[126u].z;
        RVar[127u].x = (_3010 * CBUFFER_3.values[18].y) + RVar[127u].x;
        RVar[127u].y = (_3010 * CBUFFER_3.values[18].z) + _3021;
        RVar[127u].z = (_3010 * CBUFFER_3.values[18].x) + _3027;
        RVar[126u].x = (_3010 * CBUFFER_3.values[18].w) + _3036;
        float _3044 = RVar[2u].x;
        float _3046 = RVar[5u].y;
        ...
        float _3073 = RVar[127u].x;
        float _3082 = RVar[127u].y;
        float _3088 = RVar[126u].x;
        RVar[1u].x = (_3062 * CBUFFER_3.values[19].x) + RVar[127u].z;
        RVar[2u].y = (_3062 * CBUFFER_3.values[19].y) + _3073;
        RVar[1u].w = (_3062 * CBUFFER_3.values[19].z) + _3082;
        RVar[4u].y = (_3062 * CBUFFER_3.values[19].w) + _3088;
        RVar[1u].y = dot(vec4(RVar[2u].x, RVar[5u].y, RVar[1u].z, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[13].x, CBUFFER_3.values[13].y, CBUFFER_3.values[13].z, uintBitsToFloat(0u)));
        RVar[2u].w = min(max(-dot(vec4(_3044, _3046, _3048, uintBitsToFloat(2147483648u)), vec4(CBUFFER_3.values[12].x, CBUFFER_3.values[12].y, CBUFFER_3.values[12].z, uintBitsToFloat(0u))), uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
    }
    ...
    if (stateVar == 0)
    {
        float _3154 = RVar[1u].y;
        float _3168 = RVar[2u].w;
        float _3172 = RVar[2u].y;
        float _3176 = RVar[2u].w;
        float _3180 = RVar[1u].w;
        float _3184 = RVar[2u].w;
        float _3188 = RVar[4u].y;
        RVar[127u].y = (RVar[2u].w * CBUFFER_3.values[20].x) + RVar[1u].x;
        RVar[127u].z = (_3168 * CBUFFER_3.values[20].y) + _3172;
        RVar[127u].w = (_3176 * CBUFFER_3.values[20].z) + _3180;
        RVar[126u].w = (_3184 * CBUFFER_3.values[20].w) + _3188;
        float _3196 = RVar[2u].x;
        float _3198 = RVar[5u].y;
        float _3200 = RVar[1u].z;
        float _3214 = min(max(-_3154, uintBitsToFloat(0u)), uintBitsToFloat(1065353216u));
        float _3228 = RVar[127u].w;
        float _3234 = RVar[127u].y;
        float _3240 = RVar[126u].w;
        RVar[127u].x = (_3214 * CBUFFER_3.values[21].y) + RVar[127u].z;
        RVar[127u].z = (_3214 * CBUFFER_3.values[21].z) + _3228;
        RVar[127u].w = (_3214 * CBUFFER_3.values[21].x) + _3234;
        RVar[126u].z = (_3214 * CBUFFER_3.values[21].w) + _3240;
        ...
        RVar[7u].w = clamp(RVar[4u].x * CBUFFER_3.values[42].x, 0.0, 1.0);
        float _3268 = RVar[127u].z;
        float _3275 = RVar[127u].w;
        float _3282 = RVar[127u].x;
        RVar[4u].x = clamp((_3248 * CBUFFER_3.values[22].w) + RVar[126u].z, 0.0, 1.0);
        RVar[5u].y = clamp((_3248 * CBUFFER_3.values[22].z) + _3268, 0.0, 1.0);
        RVar[1u].z = clamp((_3248 * CBUFFER_3.values[22].x) + _3275, 0.0, 1.0);
        RVar[1u].w = clamp((_3248 * CBUFFER_3.values[22].y) + _3282, 0.0, 1.0);
    }
    PARAM_1 = RVar[7u];
    if (stateVar == 0)
    {
        float _3307 = RVar[1u].z;
        float _3310 = clamp((CBUFFER_4.values[2].x * CBUFFER_3.values[23].x) + _3307, 0.0, 1.0);
        float _3316 = RVar[1u].w;
        float _3319 = clamp((CBUFFER_4.values[2].y * CBUFFER_3.values[23].y) + _3316, 0.0, 1.0);
        RVar[123u].z = _3310;
        RVar[123u].w = _3319;
        float _3329 = RVar[5u].y;
        float _3332 = clamp((CBUFFER_4.values[2].z * CBUFFER_3.values[23].z) + _3329, 0.0, 1.0);
        float _3334 = RVar[4u].x;
        RVar[123u].y = _3332;
        float _3348 = RVar[5u].z;
        float _3355 = RVar[3u].x;
        RVar[4u].y = RVar[3u].y * max(_3319, uintBitsToFloat(1065353216u));
        RVar[4u].x = _3355 * max(_3310, uintBitsToFloat(1065353216u));
        float _3360 = RVar[5u].z;
        float _3364 = (_3360 * CBUFFER_4.values[17].z) + (_3348 * CBUFFER_4.values[17].w);
        float _3366 = RVar[3u].z;
        float _3369 = RVar[3u].w;
        float _3372 = RVar[5u].z;
        RVar[123u].x = _3364;
        RVar[4u].z = _3366 * max(_3332, uintBitsToFloat(1065353216u));
        RVar[4u].w = _3369 * max(clamp(_3334 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u));
        float _3394 = RVar[5u].z;
        ...
        RVar[127u].x = (_3394 * CBUFFER_4.values[20].z) + (_3372 * CBUFFER_4.values[20].w);
        RVar[0u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[18]);
        float _3431 = RVar[5u].z;
        RVar[1u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[127u].x, uintBitsToFloat(0u)), vec4(CBUFFER_4.values[20].x, CBUFFER_4.values[20].y, uintBitsToFloat(1065353216u), uintBitsToFloat(0u)));
        RVar[1u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, _3431 * CBUFFER_4.values[21].w), vec4(CBUFFER_4.values[21].x, CBUFFER_4.values[21].y, CBUFFER_4.values[21].z, uintBitsToFloat(1065353216u)));
        RVar[2u].x = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[23]);
        RVar[2u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[5u].z, RVar[5u].z), CBUFFER_4.values[24]);
        RVar[3u].x = dot(vec4(RVar[5u].x, RVar[8u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[26]);
        RVar[3u].y = dot(vec4(RVar[5u].x, RVar[8u].y, RVar[2u].z, RVar[2u].z), CBUFFER_4.values[27]);
    }
    PARAM_2 = RVar[4u];
    ...
    PARAM_6 = vec4(RVar[3u].x, RVar[3u].y, RVar[3u].z, RVar[3u].z);
    if (stateVar == 0)
    {
    }
}
