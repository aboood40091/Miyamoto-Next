...
void main()
{
    ...
    if (stateVar == 0)
    {
        ...
        RVar[21u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[3u].w), CBUFFER_1.values[0]);
        RVar[127u].x = _118 * CBUFFER_1.values[0].z;
        RVar[21u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[3u].w), CBUFFER_1.values[1]);
        RVar[21u].z = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[3u].w), CBUFFER_1.values[2]);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[21u].x = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[3u].w), RVar[0u]);
        RVar[127u].x = _306 * _308;
        RVar[21u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[3u].w), RVar[2u]);
        RVar[21u].z = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[3u].w), RVar[1u]);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[127u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[3u].w), RVar[11u]);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[1u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[3u].w), RVar[11u]);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[127u].z = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[3u].w), RVar[16u]);
    ...
    if (stateVar == 0)
    {
        ...
        bool _1441 = floatBitsToInt(RVar[0u].w) == (0);
        predVar = _1441;
        stateVar = _1441 ? 0 : 1;
    }
    if (stateVar == 0)
    ...
    if (stateVar == 0)
    {
        ...
        RVar[0u].w = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[3u].w), RVar[11u]);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[127u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[3u].w), RVar[15u]);
        RVar[0u].y = (_1690 * dot(vec4(_1669, _1671, _1673, _1675), _1678)) + uintBitsToFloat(0u);
        float _1738 = RVar[4u].z;
        float _1740 = RVar[14u].z;
        RVar[126u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[3u].w), RVar[14u]);
        RVar[125u].x = _1738 * _1740;
        float _1757 = RVar[4u].z;
        float _1759 = RVar[9u].z;
        RVar[125u].y = dot(vec4(RVar[5u].x, RVar[5u].y, RVar[5u].z, RVar[3u].w), RVar[9u]);
    ...
    do
    {
        ...
        if (stateVar == 0)
        {
            RVar[0u].w = intBitsToFloat((floatBitsToInt(CBUFFER_1.values[3].x) > floatBitsToInt(RVar[11u].x)) ? (-1) : 0);
    ...
    if (stateVar == 0)
    {
        ...
        RVar[2u].w = max(clamp(_3323 + CBUFFER_4.values[2].w, 0.0, 1.0), uintBitsToFloat(0u)) * CBUFFER_4.values[0].w;
        float _3387 = RVar[7u].z;
        ...
        RVar[0u].y = dot(vec4(RVar[6u].x, RVar[6u].y, RVar[7u].z, _3387 * CBUFFER_4.values[18].w), vec4(CBUFFER_4.values[18].x, CBUFFER_4.values[18].y, CBUFFER_4.values[18].z, uintBitsToFloat(1065353216u)));
        ...
        RVar[4u].x = dot(vec4(RVar[7u].x, RVar[7u].y, RVar[9u].z, RVar[9u].z), CBUFFER_4.values[26]);
        RVar[4u].y = dot(vec4(RVar[7u].x, RVar[7u].y, RVar[9u].z, RVar[9u].z), CBUFFER_4.values[27]);
    }
    PARAM_2 = RVar[2u];
